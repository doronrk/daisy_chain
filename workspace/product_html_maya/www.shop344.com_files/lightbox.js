...
// July 15th, 2009
//  add imageDescription to display image description, check for the image_desc attr in the link
// -----------------------------------------------------------------------------------
/*
...
Lightbox.prototype = {
	...
	initialize: function() {
		...
		// image description
		var objImageDescription = document.createElement("div");
		objImageDescription.setAttribute('id', 'imageDescription');
		objImageData.appendChild(objImageDescription);
	...
	start: function(imageLink) {
		...
		function getImageDesc(anchor) {
			var ddimageDesc = anchor.getAttribute('image_desc');
			return ddimageDesc;
		};
		...
		if ((imageLink.getAttribute('rel') == 'lightbox')) {
			...
			for (var i = 0; i < anchors.length; i++) {
				...
				if (anchor.getAttribute('href') && (anchor.getAttribute('rel') == imageLink.getAttribute('rel'))) {
					imageArray.push(new Array(anchor.getAttribute('href'), getImageTitle(anchor), getImageDesc(anchor)));
				}
			}
	...
	//
	//	updateDetails()
	//	Display caption, image number, image description and bottom nav.
	//
	updateDetails: function() {

		Element.show('caption');
		if (imageArray[activeImage][1] != null) {
		...
		if (imageArray[activeImage][2] != null && imageArray[activeImage][2] != "") {
			Element.show('imageDescription');
			Element.setInnerHTML('imageDescription', imageArray[activeImage][2]);
		}

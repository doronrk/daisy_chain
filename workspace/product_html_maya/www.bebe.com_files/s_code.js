...
var isFullSite = true;
if (typeof responsiveUtil !== "undefined" && responsiveUtil) {
    isFullSite = (responsiveUtil.isDesktop() || responsiveUtil.isTablet());
}
if (isFullSite) {
    if(siteURL.indexOf('2b-stg2.ms.fry.com') >-1
        || siteURL.indexOf('2b-stg3.ms.fry.com') >-1
        || siteURL.indexOf('2b-stg.ms.fry.com') >-1
        || siteURL.indexOf('2b-qa.ms.fry.com') >-1
        || siteURL.indexOf('local-2b.fry.com') >-1
        || siteURL.indexOf('2b-dev3') >-1
        || siteURL.indexOf('bb-ou-stg2.ms.fry.com') >-1
        || siteURL.indexOf('bb-ou-stg.ms.fry.com') >-1){
        var s_account="2bdev";
    }
    if(siteURL.indexOf('.2bbebe.com')>-1
        || siteURL.indexOf('bebeoutlets.com') >-1){
        var s_account="2bprod";
    }
    if(siteURL.indexOf('bb-stg2.ms.fry.com') >-1
        || siteURL.indexOf('bb-stg3.ms.fry.com') >-1
        || siteURL.indexOf('bb-stg.ms.fry.com') >-1
        || siteURL.indexOf('bb-qa.ms.fry.com') >-1
        || siteURL.indexOf('local-bb.fry.com') >-1
        || siteURL.indexOf('bb-dev3') >-1) {
        var s_account="bebedev";
    }
    if(siteURL.indexOf('.bebe.com')>-1) {
        var s_account="amznbebecom";
    }
} else {
    if(siteURL.indexOf('2b-stg2.ms.fry.com') >-1
        || siteURL.indexOf('2b-stg3.ms.fry.com') >-1
        ...
        || siteURL.indexOf('bb-ou-stg2.ms.fry.com') >-1
        || siteURL.indexOf('bb-ou-stg.ms.fry.com') >-1){
        var s_account="2bmobiledev";
    }
    if(siteURL.indexOf('.2bbebe.com')>-1
        || siteURL.indexOf('bebeoutlets.com') >-1) {
        var s_account="2bmobileprod";
    }
    if(siteURL.indexOf('bb-stg2.ms.fry.com') >-1
        || siteURL.indexOf('bb-stg3.ms.fry.com') >-1
        || siteURL.indexOf('bb-stg.ms.fry.com') >-1
        ...
        || siteURL.indexOf('local-bb.fry.com') >-1
        || siteURL.indexOf('bb-dev3') >-1) {
        var s_account="bebemobiledev";
    }
    if(siteURL.indexOf('.bebe.com')>-1) {
        var s_account="bebemobileprod";
    }
}
...
s.linkInternalFilters="javascript:,bebe.com,bebeoutlets.com,fry.com,2bbebe.com"
...
/***********************************BEGIN INTERNAL SEARCH CONFIG *************/
s.successfulSearchEvent 	= 'event36';
s.nullSearchEvent 			= 'event37';
s.searchTermVariable		= 'eVar2';
/***********************************END INTERNAL SEARCH CONFIG ***************/

// timeparting config variables
s.dstStart="3/11/2012"; // update to the correct Daylight Savings Time start date for the current year.
s.dstEnd="11/04/2012"; // update to the correct Daylight Savings Time end date for the current year.
...
/****************NEW VS REPEAT BEGIN********************/
s.eVar37=s.getNewRepeat(30);

/****************NEW VS REPEAT END**********************/

/**************************BEGIN EXTERNAL CAMPAIGNS CODE BLOCK*****************/
if(!s.campaign){
	s.campaign=s.getQueryParam('extid');
	s.campaign=s.getValOnce(s.campaign,'s_campaign',30);
}
/**************************END EXTERNAL CAMPAIGNS CODE BLOCK*******************/
/**************************BEGIN INTERNAL CAMPAIGNS CODE BLOCK*****************/
if(!s.eVar1){
	s.eVar1=s.getQueryParam('intid');
	s.eVar1=s.getValOnce(s.eVar1,'s_evar1',30);
}
/**************************END INTERNAL CAMPAIGNS CODE BLOCK*******************/

/**************************BEGIN INTERNAL SEARCH CODE BLOCK***********/
	if(s.prop2){ 
	...
	if((s.events=='event36')&&(!s.products)){
	   s.products=';';
	}
/**************************END INTERNAL SEARCH CODE BLOCK*************/
/*********BEGIN PRODUCT FINDING METHODS CAMPAIGNS CODE BLOCK**********/
	if(s.campaign&&!s.eVar14)
		s.eVar14='external campaign';
	if(s.eVar2&&!s.eVar14)
		s.eVar14='internal search';
	if(s.eVar1&&!s.eVar14)
		s.eVar14='internal campaign';
	if(s.eVar34&&!s.eVar14)
		s.eVar14='browse';
	if(s.eVar35&&!s.eVar14)
		s.eVar14='browse';

	/* Product Finding Method Last Touch*/
	if(s.campaign&&!s.eVar61)
		s.eVar61='external campaign';
	if(s.eVar2&&!s.eVar61)
		s.eVar61='internal search';
	if(s.eVar1&&!s.eVar61)
		s.eVar61='internal campaign';
	if(s.eVar34&&!s.eVar61)
		s.eVar61='browse';
	if(s.eVar35&&!s.eVar61)
		s.eVar61='browse';

	
	
	/*Other External Sites*/
	if(document.referrer&&!s.eVar14&&!s.eVar61)
	{
		...
		if(!internalFlag)
			...
			s.eVar61="external non-campaign";
		}
/*********END PRODUCT FINDING METHODS CAMPAIGNS CODE BLOCK************/

/************************BEGIN TIME PARTING CODE BLOCK**********/	
var theYear = new Date().getFullYear();
s.eVar17=s.getTimeParting('','-8','');
/************************END TIME PARTING CODE BLOCK**********/

/************************BEGIN copy purchase ID**********/	
if (s.purchaseID) {
	s.eVar3=s.purchaseID;
}
/************************END copy purchase ID**********/
...
s.visitorNamespace="bebe"
s.trackingServer="bebe.d2.sc.omtrdc.net"

...
/**
 * Declares a new render context for the Recaptcha Response.
 */
wc.render.declareContext("recaptchaResponseDisplayContext",null,"")
/**
 * Declares a new render context for the Recaptcha Response.
 */
wc.render.declareContext("creditAmountDisplayContext",null,"")
/**
 * Declares a new render context for the Recaptcha Response.
 */
wc.render.declareContext("firstGiftCardAmountDisplayContext",null,"")
/**
 * Declares a new render context for the Recaptcha Response.
 */
wc.render.declareContext("secondGiftCardAmountDisplayContext",null,"")
/**
 * Declares a new render context for the Gift Card Display.
 */
/*wc.render.declareContext("GiftCardDisplayContext",null,"")
*/
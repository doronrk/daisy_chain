...
/* Build Date 11/25/2014 2:55:05 PM */
...
identifiers.SessionID=_ltk.GetCookie("STSID");assembler=new _Assembler();assembler.QueryMode=1;assembler.EndPointArray=new Array();assembler.EndPointArray.push('at1.listrakbi.com');assembler.EndPointPath='/Handlers/Set.ashx';assembler.QueryHeader='ctid=5q6IHb3tczGi&uid='+_ltk.uuidCompact()+'&gsid='+_ltk.Session.GlobalID;assembler.AddObject(identifiers);assembler.AddArrayObject(activityArray);assembler.Flush();activityArray.length=0;}
...
_Alerts.prototype.Load=function(){this.MerchantTrackingID='5q6IHb3tczGi';}
...
var modalUID="a66c31b2-6820-4ebb-9174-0e8d5d2b494e";var modalSettings={"ModalName":"Modal - Pokkadot.com","SuppressionCode":"Modal - Pokkadot.com","FollowUpDelay":3456000,"TriggerOptions":{"TriggerType":1},"DisplayOptions":{"FormHTML":"<!-- Form: BEGIN -->\r\n\r\n<div id=\"ltkmodal-wrapper\" class=\"signup\" name=\"version1\">\r\n  <div id=\"close-button\"><a class=\"ltkmodal-close close-button\"></a></div>\r\n  <div id=\"ltkmodal-contentarea\" class=\"signup\">\r\n    <div id=\"contentInformation\">\r\n      <div class=\"float-left\">\r\n        <img src=\"http://modernnursery.com/media/misc/modern/headline.png\" class=\"submit-title\"alt=\"Recieve 10% Off!\">\r\n        <p>Receive <span class=\"bold-offer\">10% off</span> your next order, plus <span class=\"bold-offer\">10 Reward Points</span> when you sign up for PokkaDots.com emails.</p>\r\n       </div>\r\n        <div class=\"form\">\r\n          <div class=\"field\">\r\n            <input tabindex=\"1\" type=\"text\" id=\"ltkmodal-email\" class=\"ltk-textbox ltkmodal-email\" name=\"email\" size=\"40\" maxlength=\"100\" ltk-watermark=\"email address\" />\r\n          </div>\r\n          <div class=\"ltk-buttons\">\r\n            <input type=\"button\" id=\"signup\" tabindex=\"10\" class=\"ltkmodal-subscribe\" title=\"Sign Up\" Value=\" \">\r\n            <a class=\"ltkmodal-close ltkmodal-no-thanks\">maybe later</a></div>\r\n            <div class=\"float-left\">\r\n            <p class=\"learn-more\">What are Reward Points? <strong><a href=\"http://www.pokkadots.com/reward-points\" title=\"Learn More\" target=\"_blank\" class=\"learn-more\">Learn More.</a></strong></p>\r\n            </div>\r\n            <div class=\"field\">\r\n            <input type=\"hidden\" class=\"text\" name=\"Source.Modal\" size=\"40\" maxlength=\"100\" value=\"On\" />\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class=\"clear\"></div>\r\n    </div>\r\n  </div>\r\n</div>\r\n<script type=\"text/javascript\">\r\n(function () { watermarkInit = function () { var e = document.querySelectorAll(\"[ltk-watermark]\"); for (var t = 0; t < e.length; t++) { addWatermark(e[t]); e[t].addEventListener(\"blur\", function () { addWatermark(this) }, false); e[t].addEventListener(\"focus\", function () { clearWatermark(this) }, false) } var n = document.getElementsByClassName(\"ltkmodal-subscribe\"); n[0].addEventListener(\"click\", function () { listrakWatermarker() }, false) }; listrakWatermarker = function () { var e = document.querySelectorAll(\"[ltk-watermark]\"); for (var t = 0; t < e.length; t++) { clearWatermark(e[t]) } }; clearWatermark = function (e) { var t = e.getAttribute(\"ltk-watermark\"); if (e.value == t) { e.value = \"\" } }; addWatermark = function (e) { var t = e.getAttribute(\"ltk-watermark\"); if (e.value == \"\") { e.value = t } }; watermarkInit() })()\r\n</script>\r\n<style type=\"text/css\">\r\n\r\n/********** CUSTOM STYLES ***********/\r\n/****** Add Custom Styles Here ******/\r\n\r\n\r\n\r\n/* Modal Width */\r\n#ltkmodal-container {width: 380px !important;}\r\n#ltkmodal-wrapper {width: 380px;}\r\n\r\n/* Z-Index */\r\n#ltkmodal-overlay {z-index: 1001 !important;}\r\n#ltkmodal-container {z-index: 1002 !important;}\r\n\r\n/* Overlay Color */\r\n#ltkmodal-overlay {\r\n\tbackground-color: #000000 !important;\r\n\topacity: 0.8 !important;\r\n\twidth: 100% !important;\r\n}\r\n\r\n/* Simple Modal Wrapper */\r\n#ltkmodal-container .simpleltkmodal-wrap {\r\n\theight: auto !important;\r\n}\r\n\r\n/* Body */\r\n#ltkmodal-contentarea {\r\n\twidth: 100%;\r\n\tfont-family: 'Open-Sans', 'Open Sans', 'Helvetica Neue', Helvetica, Verdana, sans-serif;\r\n\tfont-size: 13px;\r\n\tcolor: #686868;\r\n\ttext-align: center;\r\n\tbackground: url(http://modernnursery.com/media/misc/modern/modal-bg.jpg) top center;\r\n\tbackground-position: top center;\r\n\tborder: 3px solid #d6d4d5;\r\n\toverflow: hidden;\r\n}\r\n#ltkmodal-contentarea #contentInformation {\r\n\tpadding: 0px;\r\n\tmargin: 0px;\r\n\t\r\n\t/* Border Styles */\r\n\t/* border: 5px solid #DDDDDD;\r\n\tborder-radius: 5px 5px 5px 5px; */\r\n\t\r\n\t/* REMEMBER to reduce .float-left width */\r\n}\r\n#ltkmodal-contentarea .float-left {\r\n\twidth: 100%;\r\n}\r\n#ltkmodal-contentarea .clear {\r\n\tclear: both;\r\n}\r\n#ltkmodal-contentarea .sprites {\r\n\twidth: 100%;\r\n\theight: 45px;\r\n\tpadding: 0px 0px 13px;\r\n}\r\n\r\n/* Close X Button */\r\n#ltkmodal-wrapper #close-button {\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tright: 0;\r\n\tmargin: 15px 0 0;\r\n}\r\n#ltkmodal-wrapper .close-button {\r\n\theight: 17px;\r\n\twidth: 17px;\r\n\tbackground-image: url('http://modernnursery.com/media/misc/modern/x.png');\r\n\tbackground-position: 0 0;\r\n\tbackground-size: 17px auto;\r\n\tbackground-repeat: no-repeat;\r\n\tpadding: 5px;\r\n\tdisplay: block;\r\n\tcursor: pointer;\r\n\tvertical-align: middle;\r\n}\r\n\r\n/* Text Styles */\r\n\r\n#ltkmodal-contentarea h1 {\r\n\tfont-family: 'Open-Sans', 'Open Sans', 'Helvetica Neue', Helvetica, Verdana, sans-serif;\r\n\tfont-size: 16px;\r\n\ttext-align: center;\r\n\tfont-weight: bold;\r\n\tcolor: #e56f17;\r\n\tmargin: 0 auto;\r\n}\r\n#ltkmodal-contentarea h2 {\r\n\tfont-family: 'Open-Sans', 'Open Sans', 'Helvetica Neue', Helvetica, Verdana, sans-serif;\r\n\tfont-size: 15px;\r\n\tline-height: 22px;\r\n\ttext-align: center;\r\n\tfont-weight: 200;\r\n\tfont-style: italic;\r\n\tcolor: #686868;\r\n\tmargin: 0;\r\n\tpadding: 10px 0px 20px;\r\n}\r\n#ltkmodal-contentarea p {\r\n\tfont-family: 'Open-Sans', 'Open Sans', 'Helvetica Neue', Helvetica, Verdana, sans-serif;\r\n\tfont-size: 13px;\r\n\tline-height: 20px;\r\n\tcolor: #686868;\r\n\tfont-weight: 200;\r\n\tmargin: 0;\r\n\tpadding: 8px 30px;\r\n}\r\n#ltkmodal-contentarea .bold-offer {\r\n\tcolor: #e56f17;\r\n\tfont-weight: bold;\r\n}\r\n#ltkmodal-contentarea p.learn-more {\r\n\tcolor: #686868;\r\n\tfont-size: 12px;\r\n\tfont-style: italic;\r\n\tpadding: 5px 0px 10px;\r\n}\r\n#ltkmodal-contentarea p.confirm {\r\n\tcolor: #be7011;\r\n\tfont-weight: 200;\r\n\tmargin: 0;\r\n\tpadding: 5px 0px 10px;\r\n}\r\n#ltkmodal-contentarea a {\r\n\tcolor: #4d8fd9;\r\n\tcursor: pointer;\r\n\ttext-decoration: underline;\r\n}\r\n#ltkmodal-contentarea a:hover {\r\n\ttext-decoration: none;\r\n}\r\n#ltkmodal-contentarea a.learn-more {\r\n\tcolor: #22aee6;\r\n\ttext-decoration: none;\r\n}\r\n#ltkmodal-contentarea img.submit-title {\r\n\theight: 79px;\r\n\twidth: 322px;\r\n\tmargin: 36px auto 10px;\r\n}\r\n#ltkmodal-contentarea img.confirm-title {\r\n\theight: 88px;\r\n\twidth: 298px;\r\n\tmargin: 36px auto 10px;\r\n}\r\n\r\n\r\n/* Form Fields and Inputs */\r\n#ltkmodal-contentarea .form {\r\n\tclear: both;\t\r\n\tmargin: 13px 0px 0px; \r\n}\r\n#ltkmodal-contentarea .field {\r\n\tmargin: 5px 0;\r\n}\r\n#ltkmodal-contentarea input.ltk-textbox {\r\n\tfont-family: 'Open-Sans'. 'Open Sans', 'Helvetica Neue', Helvetica, Verdana, sans-serif;\r\n\tfont-size: 13px;\r\n\tcolor: #666666;\r\n\tfont-style: italic;\r\n\tmargin: 0 auto;\r\n\tdisplay: block;\r\n\twidth: 80%;\r\n\tborder: 1px solid #cae4ee;\r\n\tpadding: 8px 5px;\r\n\ttext-align: center;\r\n\tvertical-align: middle;\r\n\tbox-sizing: border-box;\r\n}\r\n#ltkmodal-contentarea .select-wrapper span {\r\n\tline-height: 21px;\r\n}\r\n\r\n/* Buttons */\r\n#ltkmodal-contentarea .ltk-buttons {\r\n\tmargin: 10px auto 0;\r\n\tdisplay: inline-block;\r\n}\r\n#ltkmodal-contentarea .ltkmodal-subscribe {\r\n\tbackground: #e56f17 url('http://modernnursery.com/media/misc/modern/signup.png') no-repeat center center;\r\n\tbackground-position: center;\r\n\tborder: 1px solid #e56f17;\r\n\tcursor: pointer;\r\n\twidth: 140px;\r\n\tcolor: #fff;\r\n\tdisplay: block;\r\n\tpadding: 8px 0;\r\n\ttext-decoration: none;\r\n\tvertical-align: middle;\r\n\tmargin: 0 auto 5px;\r\n}\r\n#ltkmodal-contentarea .ltkmodal-no-thanks {\r\n\tcolor: #686868;\r\n\tfont-size: 12px;\r\n\tvertical-align: middle;\r\n\tdisplay: block;\r\n\ttext-decoration: none;\r\n\tpadding: 15px 0px 10px;\r\n}\r\n#ltkmodal-contentarea a.facebook-sprite{\r\n\theight: 49px;\r\n\twidth: 50px;\r\n\tbackground: url('http://modernnursery.com/media/misc/modern/facebook-sprite.png');\r\n\tbackground-position: 0 0;\r\n\tdisplay: inline-block;\r\n\tbackground-size: 50px auto;\r\n}\r\n#ltkmodal-contentarea a.facebook-sprite:hover,\r\n#ltkmodal-contentarea a.facebook-sprite:active {\r\n\theight: 49px;\r\n\twidth: 50px;\r\n\tbackground-position: 0 -48px;\r\n}\r\n#ltkmodal-contentarea a.twitter-sprite{\r\n\theight: 49px;\r\n\twidth: 50px;\r\n\tbackground: url('http://modernnursery.com/media/misc/modern/twitter-sprite.png');\r\n\tbackground-position: 0 0;\r\n\tdisplay: inline-block;\r\n\tbackground-size: 50px auto;\r\n}\r\n#ltkmodal-contentarea a.twitter-sprite:hover,\r\n#ltkmodal-contentarea a.twitter-sprite:active {\r\n\theight: 49px;\r\n\twidth: 50px;\r\n\tbackground-position: 0 -48px;\r\n}\r\n#ltkmodal-contentarea .social-icons {\r\n\theight: 49px;\r\n\tmargin: 0px 12px;\r\n}\r\n\r\n\r\n\r\n\r\n/* Mobile Styles */\r\n@media only screen and (max-width : 480px) {\r\n\t\r\n/* Modal Width */\r\n#ltkmodal-container {\r\n\twidth: 90% !important; \r\n     position: absolute !important;\r\n     margin-left: auto !important;\r\n     left: 5% !important;\r\n}\r\n#ltkmodal-wrapper {\r\n\twidth: 300px !important;\r\n\tposition:absolute !important;\r\n}\r\n\r\n/* Body */\r\n#ltkmodal-contentarea .confirm {\r\n\tpadding-top: 15px !important;\r\n}\r\n\r\n#ltkmodal-contentarea {\r\n\ttext-align: center;\r\n}\r\n#ltkmodal-contentarea #contentInformation {\r\n\tpadding: 0px;\r\n}\r\n#ltkmodal-contentarea .float-left {\r\n\twidth: 100%;\r\n}\r\n#ltkmodal-wrapper .mobileHide {\r\n\tdisplay: none;\r\n}\r\n\r\n/* Close X Button */\r\n#ltkmodal-wrapper #close-button {\r\n\tmargin: 10px 0 0;\r\n}\r\n\r\n/* Type */\r\n#ltkmodal-contentarea h1 {\r\n\tfont-size: 15px;\r\n\tpadding-bottom: 10px;\r\n}\r\n#ltkmodal-contentarea h2 {\r\n\tpadding: 5px 0 20px;\r\n}\r\n#ltkmodal-contentarea .title-bolder {\r\n\tfont-size: 51px;\r\n}\r\n#ltkmodal-contentarea p {\r\n\tline-height: 21px;\r\n\tpadding: 0px 15px 20px;\r\n}\r\n#ltkmodal-contentarea p.learn-more{\r\n\tpadding: 12px 0px 10px;\r\n\tfont-size: 13px;\r\n}\r\n#ltkmodal-contentarea a.ltkmodal-no-thanks{\r\n\tfont-size: 13px;\r\n\tpadding: 15px 0px 0px;\r\n}\r\n#ltkmodal-contentarea img.submit-title {\r\n\twidth: 260px;\r\n\theight: auto;\r\n\tmargin: 48px auto 20px;\r\n}\r\n#ltkmodal-contentarea img.confirm-title{\r\n\twidth: 260px;\r\n\theight: auto;\r\n\tmargin: 48px auto 15px;\r\n}\r\n\r\n/* Form Fields and Inputs */\r\n#ltkmodal-contentarea .form {\r\n\tmargin: 0px 0px 0px;\r\n}\r\n#lktmodal-contentarea .field {\r\n\tmargin: 0px 0px 5px;\r\n}\r\n#ltkmodal-contentarea input.ltk-textbox {\r\n\twidth: 250px;\r\n\theight: 40px;\r\n}\r\n\r\n#ltkmodal-contentarea input.textbox {\r\n\twidth: 250px;\r\n\theight: 40px;\r\n\tmargin: 0 auto;\r\n\ttext-align: center;\r\n\tpadding-left: 0;\r\n}\r\n#ltkmodal-contentarea .ltkmodal-subscribe {\r\n\tbackground-color: #e56f17;\r\n\twidth: 250px;\r\n\theight: 40px;\r\n\tbackground-size: 20% auto;\r\n}\r\n\r\n}\r\n\r\n</style>\r\n\r\n<!-- Form: END -->","OverlayClose":true,"InitDelay":3},"ActionOptions":{"SubscriberSettingsCode":"Modal - Pokkadot","ActionType":0},"ConfirmationOptions":{"ConfHTML":"<!-- Confirm: START -->\r\n\r\n<div id=\"ltkmodal-wrapper\" class=\"confirm\" name=\"version1\">\r\n  <div id=\"close-button\"><a class=\"ltkmodal-close close-button\"></a></div>\r\n  <div id=\"ltkmodal-contentarea\" class=\"confirm\">\r\n    <div id=\"contentInformation\">\r\n        <img src=\"http://modernnursery.com/media/misc/modern/headline2.png\" class=\"confirm-title\" alt=\"and you shopped happily ever after\">\r\n        <h1>Thanks for signing up!</h1>\r\n        <p>Check your inbox for your coupon code.</p>\r\n    </div>\r\n    <div class=\"contentInformation\">\r\n    \t<h2>Share your happily ever after.</h2>\r\n    \t<div class=\"sprites\">\r\n    \t<a href=\"https://www.facebook.com/pokkadots\" title=\"Facebook\" class=\"facebook-sprite social-icons\" target=\"_blank\">\r\n    \t</a>\r\n\r\n    \t<a href=\"https://twitter.com/pokkadotsonline\" title=\"Twitter\" class=\"twitter-sprite social-icons\" target=\"_blank\">\r\n    \t</a>\r\n    \t</div>\r\n    </div>\r\n    <div class=\"clear\"></div>\r\n  </div>\r\n</div>\r\n<style type=\"text/css\">\r\n\r\n/* Confirm Styles */\r\n#ltkmodal-contentarea.confirm {\r\n\ttext-align: center;\r\n\tpadding-bottom: 20px;\r\n}\r\n\r\n</style>\r\n\r\n<!-- Confirm: END --> ","RedirURL":"","AutoClose":0},"EligibilityOptions":{"UASuppression":null,"UrlRules":["/account/*","/checkout/*","https://s-static.ak.facebook.com/*","statictab"],"TestMode":false,"NewSessionsOnly":true,"UrlRulesMode":2}};_ltk.Modal.add(modalUID,modalSettings);
...
var ltk_js_script_live = function() { (function () {
    ...
    var Revision = '1.4';
    var DebugMode = true;
    function ToolBox() { this.Version = "2.3" } ToolBox.prototype.inputExists = function (e) { return typeof e !== "undefined" && e !== null }; ToolBox.prototype.getInputValueIfExists = function (e) { var t = document.getElementById(e); if (this.inputExists(t)) { return t.value } return "" }; ToolBox.prototype.getSelectedOption = function (e) { var t = typeof e === "string" ? document.getElementById(e) : e; if (this.inputExists(t)) { return t.options[t.selectedIndex] } }; ToolBox.prototype.getHookValue = function (e) { var t = typeof e === "string" ? e : "ListrakDataHook"; return this.getInputValueIfExists(t) }; ToolBox.prototype.getHooks = function (e) { var t = typeof e === "string" ? e : "ListrakDataHook"; return document.getElementsByName(t) }; ToolBox.prototype.hasDataHook = function (e) { var t = document.querySelectorAll('[id="ListrakDataHook"]'); for (var n = 0; n < t.length; n++) { if (t[n].value == e) return true } return false }; ToolBox.prototype.getURLPath = function () { return window.location.pathname }; ToolBox.prototype.findElementByAttribute = function (e, t, n, r) { var i = typeof r === "number" ? r : 0; var s = document.getElementsByTagName(e); var o = new Array; for (var u = 0; u < s.length; u++) { if (s[u].getAttribute(t) === n) { o.push(s[u]) } } return o[i] }; ToolBox.prototype.findButtonByTitle = function (e) { return this.findElementByAttribute("button", "title", e) }; ToolBox.prototype.findInputByValue = function (e) { return this.findElementByAttribute("input", "value", e) }; ToolBox.prototype.setElementBlurIfExists = function (e, t) { var n = typeof e === "string" ? document.getElementById(e) : e; if (this.inputExists(n) && typeof t === "function") { n.onblur = t } }; ToolBox.prototype.eventFire = function (e, t) { if (e.fireEvent) { e.fireEvent("on" + t) } else { var n = document.createEvent("Events"); n.initEvent(t, true, false); e.dispatchEvent(n) } }; ToolBox.prototype.appendClick = function (e, t) { var n = typeof e === "string" ? document.getElementById(e) : e; if (this.inputExists(n) && typeof t === "function") { if (n.addEventListener) n.addEventListener("click", t); else { n.attachEvent("onclick", t) } } }; ToolBox.prototype.appendEvent = function (e, t, n) { var r = typeof e === "string" ? document.getElementById(e) : e; if (this.inputExists(r) && typeof n === "function") { if (r.addEventListener) r.addEventListener(t, n) } }; ToolBox.prototype.setTriggerPoints = function (e, t, n) { var r = this; var i = typeof t === "string" ? document.getElementById(t) : t; var s = typeof e === "string" ? document.getElementById(e) : e; if (this.inputExists(i) && this.inputExists(s) && typeof n === "function") { this.appendClick(s, n); this.appendEvent(i, "keypress", function (e) { var t = e.keyCode ? e.keyCode : e.which; if (t == 13) { r.eventFire(s, "click") } }) } }; ToolBox.prototype.convertMonthNameToNumber = function (e) { switch (e.toLowerCase()) { case "january": return 1; break; case "february": return 2; break; case "march": return 3; break; case "april": return 4; break; case "may": return 5; break; case "june": return 6; break; case "july": return 7; break; case "august": return 8; break; case "september": return 9; break; case "october": return 10; break; case "november": return 11; break; case "december": return 12; break } }; ToolBox.prototype.constructBirthday = function (e, t, n) { if (typeof e === "string") { e = this.convertMonthNameToNumber(e) } if (typeof e !== "number") { return } t = typeof t === "number" ? t : 1; n = typeof n === "number" ? n : (new Date).getFullYear(); return e + "/" + t + "/" + n }; ToolBox.prototype.elementHasParent = function (e, t) { var n = typeof e === "string" ? document.getElementById(e) : e; var r = typeof t === "string" ? document.getElementById(t) : t; do { if (n === r) return true; n = n.parentElement } while (this.inputExists(n)); return false }; ToolBox.prototype.createOptInElement = function (e, t) { var n = typeof t === "string" ? n = t : n = "is_subscribed"; var r = document.createElement("div"); var i = document.createElement("input"); i.setAttribute("id", n); i.setAttribute("type", "checkbox"); i.style.marginRight = "10px"; i.style.marginTop = "4px"; i.style.cssFloat = "left"; var s = document.createElement("label"); s.htmlFor = n; s.appendChild(document.createTextNode(e)); r.isChecked = function () { return this.firstChild.checked }; r.appendChild(i); r.appendChild(s); return r }; ToolBox.prototype.executeWhenExists = function (e, t, n) { var r = typeof n === number ? r = n : 10; if (r > 0) { setTimeout(function () { var n = document.getElementById(e); if (this.inputExists(n)) t(); else this.executeWhenExists(e, t, r) }, 500) } }
    function ListrakSubscriber() { this.trigger = "*"; this.subscriptionPoint = null; this.email = null; this.profiles = Array() } function ListrakSubscriberHandler(e) { typeof e === "boolean" ? this.isDebug = e : this.isDebug = false; this.Version = Version; this.Revision = Revision; this.dataID = "ltkSubscriberObjs"; this.subscriber = new ListrakSubscriber; this.toolbox = new ToolBox; this.supportsSessionStorage = "sessionStorage" in window && window["sessionStorage"] !== null; this.Log = function (e, t) { if (this.isDebug) { t = typeof t === "string" ? t : "log"; switch (t) { case "warn": console.warn(e); break; case "info": console.info(e); break; case "debug": console.debug(e); break; case "error": console.error(e); break; default: console.log(e) } } }; this.Log("Loading LPS_LSH version " + Version + " (Toolbox v" + this.toolbox.Version + ") with debug mode - Revision: " + Revision, "debug") } ListrakSubscriberHandler.prototype.GetSubscriberData = function () { var e = sessionStorage.getItem(this.dataID); return JSON.parse ? JSON.parse(e) : JSON.decode(e) }; ListrakSubscriberHandler.prototype.SaveSubscriberData = function (e) { if (!e) { return } var t = this.GetSubscriberData(); var n; t ? n = t : n = new Array; n.push(e); var r = JSON.stringify ? JSON.stringify(n) : JSON.encode(n); sessionStorage.setItem(this.dataID, r) }; ListrakSubscriberHandler.prototype.ClearSubscriberData = function () { sessionStorage.removeItem(this.dataID); this.Log("cleared local data", "info") }; ListrakSubscriberHandler.prototype.SetSubPoint = function (e) { this.subscriber.subscriptionPoint = e; this.Log("Setting subscription point to: " + e) }; ListrakSubscriberHandler.prototype.SetEmail = function (e) { this.subscriber.email = e; this.Log("Setting email address to: " + e) }; ListrakSubscriberHandler.prototype.SetTrigger = function (e) { this.subscriber.trigger = e; this.Log("Setting trigger option to: " + e) }; ListrakSubscriberHandler.prototype.AddProfile = function (e, t) { var n = this; var r = false; n.subscriber.profiles.forEach(function (i, s, o) { if (i.ProfileName == e) { n.Log("updating value for " + i.ProfileName + " to " + t); i.ProfileValue = t; r = true } }); if (r) { return } n.subscriber.profiles.push(new Object({ ProfileName: e, ProfileValue: t })); n.Log("adding value for " + e + " : " + t) }; ListrakSubscriberHandler.prototype.Save = function () { this.Log("Saving information for: " + this.subscriber.email, "info"); this.SaveSubscriberData(this.subscriber) }; ListrakSubscriberHandler.prototype.Subscribe = function () { var e = this; if (!e.supportsSessionStorage) { e.Log("browser does not support session storage", "warn"); return } var t = e.GetSubscriberData(); if (!t) { e.Log("no subscriber data found in storage", "info"); return } var n = new Array; t.forEach(function (t, r, i) { e.Log("found subscriber data for " + t.email + " and trigger: " + t.trigger); if (t.trigger === e.toolbox.getHookValue() || t.trigger === e.toolbox.getURLPath() || t.trigger === "*") { _ltk.Subscriber.List = t.subscriptionPoint; _ltk.Subscriber.Email = t.email; t.profiles.forEach(function (e, t, n) { _ltk.Subscriber.Profile.Add(e.ProfileName, e.ProfileValue) }); _ltk.Subscriber.Submit(); e.Log("Submitting " + t.email + " to listrak!") } else { n.push(t) } }); e.ClearSubscriberData(); if (n.length > 0) e.SaveSubscriberData(n) }
    ...
    if (enableNewsletter) {
        ...
        toolbox.setTriggerPoints(newsletterButton, 'mce-EMAIL',
        function () {
            handler.SetEmail(toolbox.getInputValueIfExists('mce-EMAIL'));
            handler.SetSubPoint('Website Footer - Pokkadot');
        ...
        toolbox.appendClick(submitButton,
            function () {
                if (toolbox.inputExists(optInBox) && optInBox.checked) {
                    handler.SetEmail(toolbox.getInputValueIfExists('email_address'));
                    handler.SetSubPoint("Account Create - Pokkadot");
                    handler.AddProfile("Customer Info.First Name", toolbox.getInputValueIfExists('firstname'));
                    handler.AddProfile("Customer Info.Last Name", toolbox.getInputValueIfExists('lastname'));
    ...
    if (toolbox.getURLPath() === '/checkout/onepage/' || toolbox.getURLPath() === '/checkout/onepage/index/') {
        handler.SetTrigger('/checkout/onepage/success/');

        var guestButton = document.getElementById('login:guest'); //to check if client is registereing or guest checkout
        ...
        var paymentButton = toolbox.findElementByAttribute('button', 'onclick', 'payment.save()');

        toolbox.appendClick(submitButton,
            function () {
                if (toolbox.inputExists(optInBox) && optInBox.isChecked()) {
                    handler.SetEmail(toolbox.getInputValueIfExists('billing:email'));
                    handler.SetSubPoint("Guest Checkout - Pokkadot");
                    handler.AddProfile("Customer Info.First Name", toolbox.getInputValueIfExists('billing:firstname'));
                    handler.AddProfile("Customer Info.Last Name", toolbox.getInputValueIfExists('billing:lastname'));
                    handler.AddProfile("Customer Info.Country", toolbox.getSelectedOption('billing:country_id').text);

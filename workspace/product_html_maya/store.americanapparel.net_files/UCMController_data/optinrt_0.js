...
rtc[2] = [1988, 'http://pix.btrll.com/partner/692277.png', 7];	// 
rtc[3] = [3387, 'http://sync.adap.tv/sync?type=gif&key=valueclickinc&uid=USERTOKEN', 7];	// 
rtc[4] = [12783, 'http://pixel.rubiconproject.com/tap.php?v=5364|1|90&nid=2046&expires=90&put=USERTOKEN', 7];	// 
rtc[5] = [17100, 'http://image2.pubmatic.com/AdServer/Pug?vcode=bz0yJnR5cGU9MSZjb2RlPTQ2MSZ0bD0xNTc2ODAw&piggybackCookie=USERTOKEN', 7];	// 
rtc[6] = [3435, 'http://www.facebook.com/fr/u.php?p=282726141853322&m=USERTOKEN', 7];	// 
rtc[7] = [15900, 'http://us-u.openx.net/w/1.0/sd?id=537072954&val=USERTOKEN', 7];	// 

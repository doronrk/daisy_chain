...
var respRate = (document.domain == 'www.dillards.com' || document.domain == 'dillards.com') ? 10 : 0;
...
if (OOo.Browser.isMobile === false){
  ...
  /* OPTIONAL - Configuration */
  	...
  	, customVariables: {
		...
		, friendlyDomains: ['http://www.dillards.com','https://www.dillards.com','http://iqa.dillards.com','https://iqa.dillards.com','https://idev.dillards.com','http://idev.dillards.com']
  });
...
*/
function trackOOClick(){
	var cookieVal = $.cookie("trackOOClick");
	if(cookieVal != null){
		cookieVal++;
		$.cookie("trackOOClick",cookieVal);
	}else{
		$.cookie("trackOOClick",1);
	}
}
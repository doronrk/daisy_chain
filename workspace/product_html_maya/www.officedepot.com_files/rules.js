rule117859_fired=0;function rule117859_func(){try{eStara_urids_to_log.push('117859');}catch(err){eStara_logerr("rule1=117859", err);}}        (function() {
        eStara_instantinvite_rule =
        {
        ...
        {
          if ( document.getElementById('invitelayer') == null ) {
            var ii_wrapper = document.createElement('div');
            ii_wrapper.setAttribute('id', 'invitelayer');
            ii_wrapper.style.position="absolute";
            ii_wrapper.style.left="10px";
            ii_wrapper.style.right="10px";
            ii_wrapper.style.visibility="hidden";
            ii_wrapper.style.zIndex="1000";

            var ii_content = document.createElement('div');
            ii_content.setAttribute('id', 'invitelayercontent');
            ii_content.style.position="relative";
            ii_content.style.left="0px";
            ii_content.style.right="0px";
            ii_content.style.zIndex="100";

            ii_wrapper.appendChild(ii_content);
            ii_content.innerHTML = '<!--[if lte IE 6]><iframe id="divshim" src="javascript:\'&lt;html&gt;&lt;/html&gt;\'" scrolling="no" frameborder="0" style="position:absolute;top:0px;left:0px;display:none;"></iframe><![endif]-->';

            document.body.appendChild(ii_wrapper);
          } else {
            //  Default layer exists - do nothing
          }
        }
      })();

      // Fire rule now
      eStara_instantinvite_rule.init(7677);

      // Pull in the II3 code and put it here
...
/* Generated: Dec 2, 2014 2:43:47 PM */
...
this.version=14;this.accountid=7677;this.ishosted=false;this.domain="";this.rsvr="rs.instantservice.com";this.gsvr="";this.vtscrname="";
this.vtscrloc="";this.GSV_COOKIE="IS3_GSV";this.HIST_COOKIE="IS3_History";this.HIST_COOKIE_EXP=null;if(this.HIST_COOKIE_EXP!=null){this.HIST_COOKIE_EXP.setTime(this.HIST_COOKIE_EXP.getTime()+(0*60*1000));
...
this.tokenizedexps={};this.abflag=9999;this.abshown=false;this.abmsg=null;this.abdeptcheck=0;this.abcheckstate=0;this.availImg=null;
this.abavailImg=null;this.checkDeptID=0;this.checkState=0;if(navigator.appName.indexOf("Microsoft")!=-1&&navigator.platform.indexOf("Mac")!=-1){this.availImg=document.createElement("IMG");
...
}if(ii_getCookie(ii_Var.GSV_COOKIE)==null){ii_resetGSVCookie();}}var ii_jsvar=new Object();ii_Var.publishversion="1417560227";
ii_Var.scrinc="";ii_Var.stringTypes=[0,0,0,0,0,0,0,0,0];ii_Var.stringNoContain=[1,6,8];ii_Var.urlStrings=["checkout.do","confirmrouter.do","www.officedepot.com","submitset.do","registrationdisplay.do","accountsummarydisplay.do","checkout.do","anonymousconfirm.do","anonymousconfirmrouter.do"];
var ii_Inv=[[57841,"BSD_Control_Discontinued_Items",1,"","invitelayer",9,9,10,8,0,"http://as00.estara.com/OneCC/200106299799/shim.gif",1,1,0,0,"http://as00.estara.com/OneCC/200106299799/shim.gif","","",0,0,0,0,0,"http://as00.estara.com/OneCC/200106299799/shim.gif","","offer_control_disc_pro","chat","trackyes","acc_control_disc_pro","chat","trackyes","rej_control_disc_pro","chat","trackyes"],[57880,"BSD_Control_Out_of_Stock",1,"","invitelayer",9,9,10,9,0,"https://as00.estara.com/OneCC/200106299799/shim.gif",1,1,0,0,"https://as00.estara.com/OneCC/200106299799/shim.gif","","",0,0,0,0,0,"https://as00.estara.com/OneCC/200106299799/shim.gif","","offer_Control_OOS_pro","chat","trackyes","acc_Control_OOS_pro","chat","trackyes","rej_Control_OOS_pro","chat","trackyes"],[57881,"BSD_Proactive_Zero_Search_Results_OD_Brand",1,"","invitelayer",3,6,30,3,1,"https://www.officedepot.com/images/us/od/chat/proactive_chat_item_error_popup.jpg",350,163,64,120,"https://www.officedepot.com/images/us/od/chat/yes_chat_btn.gif","","https://admin.instantservice.com/links/7677/45709",1,500,320,174,120,"https://www.officedepot.com/images/us/od/chat/no_chat_btn.gif","","offer_test_zero_search_pro","chat","trackyes","acc_test_zero_search_pro","chat","trackyes","rej_test_zero_search_pro","chat","trackyes"],[57882,"BSD_Control_Zero_Search_Results",1,"","invitelayer",9,9,10,9,0,"http://as00.estara.com/OneCC/200106299799/shim.gif",1,1,0,0,"http://as00.estara.com/OneCC/200106299799/shim.gif","","",0,0,0,0,0,"http://as00.estara.com/OneCC/200106299799/shim.gif","","offer_control_zero_search_pro","chat","trackyes","acc_zero_search_pro","chat","trackyes","rej_zero_search_pro","chat","trackyes"],[57921,"BSD_Control_Login_Page_Failure",1,"","invitelayer",9,9,10,9,0,"https://as00.estara.com/OneCC/200106299799/shim.gif",1,1,0,0,"https://as00.estara.com/OneCC/200106299799/shim.gif","","",0,0,0,0,0,"https://as00.estara.com/OneCC/200106299799/shim.gif","","offer_control_login_pro","chat","trackyes","acc_control_login_pro","chat","trackyes","rej_control_login_pro","chat","trackyes"],[57940,"BSD_Control_Coupon_Errors",1,"","invitelayer",9,9,10,9,0,"https://as00.estara.com/OneCC/200106299799/shim.gif",1,1,0,0,"https://as00.estara.com/OneCC/200106299799/shim.gif","","",0,0,0,0,0,"https://as00.estara.com/OneCC/200106299799/shim.gif","","offer_control_coupon_pro","chat","trackyes","acc_control_coupon_pro","chat","trackyes","rej_control_coupon_pro","chat","trackyes"],[58080,"BSD_Proactive_Coupon_OD_Brand",1,"","invitelayer",3,6,30,3,0,"https://business.officedepot.com/images/us/bsd/chat/proactive_chat_coupon_popup.jpg",350,163,64,120,"https://business.officedepot.com/images/us/bsd/chat/yes_chat_btn.gif","","https://admin.instantservice.com/links/7677/45706",1,500,320,174,120,"https://business.officedepot.com/images/us/bsd/chat/no_chat_btn.gif","","offer_test_coupon_pro","chat","trackyes","acc_test_coupon_pro","chat","trackyes","rej_test_coupon_pro","chat","trackyes"],[58100,"BSD_Proactive_Login_Failure_OD_Brand",1,"","invitelayer",2,5,10,8,0,"https://business.officedepot.com/images/us/bsd/chat/proactive_chat_login_popup.jpg",350,163,64,120,"https://business.officedepot.com/images/us/bsd/chat/yes_chat_btn.gif","","https://admin.instantservice.com/links/7677/45705",1,500,320,174,120,"https://business.officedepot.com/images/us/bsd/chat/no_chat_btn.gif","","offer_test_login_pro","chat","trackyes","acc_test_login_pro","
GWWWOutOfStock`0`0`1`1`0","5`1`6`0`100`5`0"],1,1,"45237",1,"Test_OOS_Error_trigg","chat","trackyes"],[86021,0,57880,0,"ZZBSD_Control_Out_of_Stock",["91`ATGBSDInvalid`0`0`1`1`0","92`preChatActive`0`0`0`1`0","5`96`6`0`100`5`0"],1,1,"45707",1,"Control_OOS_Error_trigg","chat","trackyes"],[85700,0,58880,0,"ZZBSD_Test_Out_of_Stock",["91`ATGBSDInvalid`0`0`1`1`0","92`preChatActive`0`0`0`1`0","5`1`6`0`95`5`0"],1,1,"45707",1,"Test_OOS_Error_trigg","chat","trackyes"]];
ii_Var.CustomOfferedJS="if(param3 == \u0022trackyes\u0022){    if(typeof(cmCreateElementTag)!=\u0027undefined\u0027){       cmCreateElementTag(param1, param2);    } } ";
ii_Var.CustomAcceptedJS="if(param3 == \u0022trackyes\u0022){if(typeof(cmCreateElementTag)!=\u0027undefined\u0027){cmCreateElementTag(param1, param2); }}";
ii_Var.CustomDeclinedJS="if(param3 == \u0022trackyes\u0022){if(typeof(cmCreateElementTag)!=\u0027undefined\u0027){cmCreateElementTag(param1, param2); }}";
ii_Var.CustomTriggeredJS="if(param3 == \u0022trackyes\u0022){    if(typeof(cmCreateElementTag)!=\u0027undefined\u0027){       cmCreateElementTag(param1, param2);    } } ";
...
if(ii_Var.IE||ii_Var.MZ){ii_start();}function eStara_check_cookies(){var keys=eStaraCookieDictionaryGetKeys('estaracookie');for(var i=0;i<keys.length;i++){var key=keys[i];if(key.match(/^rule_action_\d+$/)){var urid=key.substring(12);var value=eStaraCookieDictionaryGet('estaracookie',key);var commapos=value.indexOf(',');if(commapos!=-1){var ulbid=value.substring(0,commapos);var debug=value.substring(commapos+1);if(debug)eStara_debug('Rule:'+urid+':Found match from previous page',debug);if(ulbid!=0){eStara_append(eStara_add_var_fields('http://as00.estara.com/as/commonlink.php?accountid=200106299799&template='+ulbid+'&urid='+urid+'&host=as00.estara.com&fromrules=1&estara_fsguid=7FDF4546CC5BA810ABD48E847DDF8619&dnc=1417580049.632406391055'));eStara_urids_to_cookie.push(''+urid+'');}else eStara_urids_to_log.push(''+urid+'');eStaraCookieDictionaryDelete('estaracookie',key,true,null);}}}}eStara_check_cookies();function eStara_log_rule_action(){if(eStara_urids_to_log.length>0||eStara_urids_to_cookie.length>0){var urids='';while(eStara_urids_to_log.length>0){urid=eStara_urids_to_log.shift();if (urids!='')urids+=',';urids+=urid;}var cookieurids='';while(eStara_urids_to_cookie.length>0) {urid=eStara_urids_to_cookie.shift();if(cookieurids!='')cookieurids+=',';cookieurids+=urid;}setTimeout('eStara_append(\'http://as00.estara.com/fs/ruleaction.php?accountid=200106299799&urid='+urids+'&cookieurid='+cookieurids+'&estara_fsguid=7FDF4546CC5BA810ABD48E847DDF8619&dnc='+(new Date()).getTime()+Math.round(Math.random()*1000000)+'\');',3000);}setTimeout('eStara_log_rule_action();',3000);}eStara_log_rule_action();
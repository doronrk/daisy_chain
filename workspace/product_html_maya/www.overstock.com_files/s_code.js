...
if(navigator.userAgent.indexOf('OverstockAndroidApp') > -1){
	var s_account="overstockdroidapporders";
} else {
...
function s_doPlugins(s) {
  ...
  if(!s.prop35)s.prop35=s.getQueryParam('Design');
  if(!s.prop41)s.prop41=s.getQueryParam('recidx');
  if(!s.prop44)s.prop44=s.getQueryParam('recalg');
  ...
  if(!s.eVar67)s.eVar67=s.getQueryParam('mid');
  if(s.eVar67)s.eVar67=s.getValOnce(s.eVar67,'s_var_67',0);
  if(!s.eVar66)s.eVar66=s.getQueryParam('rid');
  ...
  if(s.getQueryParam('k_clickid') != "") {
    s.eVar69 = s.getQueryParam('k_clickid');
  }

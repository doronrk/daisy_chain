...
FSR.properties = {
    ...
    invite: {
        ...
        dialogs: [{
            ...
            attribution: "This survey is conducted by an independent company ForeSee, on behalf of bloomingdales.com.",
        ...
        exclude: {
            local: ['/bag', '/chkout', '/loyallist/enrollment', '/registry/wedding/registrycaptureemail', '/account', '/service'],
            referrer: []
        },
        include: {
            local: ['.']

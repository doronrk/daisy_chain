...
function YouTube() {
	...
	this.init = function(id) {
		...
		var yt = ('<iframe width="'+this._defaults.width+'" height="'+this._defaults.height+'" src="http://www.youtube.com/embed/'+this._defaults.id+'?rel=0&wmode=transparent'+ivpolicy+'" frameborder="0" allowfullscreen></iframe>');
		if(/msie/.test(navigator.userAgent.toLowerCase())) {

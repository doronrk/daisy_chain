...
var sc_cartcoll = 'sc.shop.josbank.com';       // REPLACE THIS WITH SUB DOMAIN
var sc_cartaff = 'JOSABANK';                      // REPLACE THIS WITH AFFILIATE
...
SC_Sku.writeImage=function(a,b,c,d,q) {
  ...
  var img = document.createElement('img');  
    if(q) {
       ...
       var pSrc = sc_prot+'://'+sc_cartcoll+'/spacer.gif?RN='+k+'&event='+p ;
   //    alert(pSrc);
       img.src = pSrc;
		$('#sc_tags').append(img);
        return;

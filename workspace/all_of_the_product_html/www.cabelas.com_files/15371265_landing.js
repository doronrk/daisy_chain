...
var ci_vid= 15371265;
var ci_cookieDomain=".cabelas.com";
var ci_refDomain=".cabelas.com";
var ci_imgs=[];
...
try {
	...
	if(ci_cpncode!==null){
		ci_CC('ci_cpncode',ci_cpncode,7);
		ci_CC('ci_src',ci_srccode,7);
		ci_CC('ci_tid',"",-1);
	} else if(ci_src!==null && ci_sku!==null) {
		ci_CC('ci_cpncode',"",-1);
		ci_CC('ci_tid',ci_tid,7);
		ci_CC('ci_src',ci_src,7);

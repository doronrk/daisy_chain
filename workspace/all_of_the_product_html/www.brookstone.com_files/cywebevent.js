...
if(typeof CUSTCODE != 'undefined')
{
  ...
  var url =  protocol+"://"+host+"/EmailCapSliderClient/sliderstyle.css?servicecode="+cy.CUSTOMERCODE+"&pagename="+sPage+testStr;
       ...
       else
       {
        ...
        oScript.src=protocol+"://"+host+"/EmailCapSliderClient/slide.js?servicecode="+cy.CUSTOMERCODE+"&pagename="+sPage+testStr;
...
//	var swd='abandonment3.saas.seewhy.com';
  	var swd='abandonment4.saas.seewhy.com';
//	var swd='test.saas.seewhy.com';

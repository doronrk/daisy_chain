...
var accountList = {
  'www.columbia.com': 'columbiaecommerce',
  'www.sorel.com': 'columbiasorel',
  'www.mountainhardwear.com': 'columbia-mhw-ecommerce',
  'www.montrail.com': 'columbia-montrail-ecommerce',
  'www.columbiasportswear.ca': 'columbiacolumbiacanada',
  'www.sorelfootwear.ca': 'columbia-sor-ca',
  'www.columbiasportswear.at': 'columbia-col-at',
  'www.columbiasportswear.be': 'columbia-col-be',
  'www.columbiasportswear.fi': 'columbia-col-fi',
  'www.columbiasportswear.fr': 'columbia-col-fr',
  'www.columbiasportswear.de': 'columbia-col-de',
  'www.columbiasportswear.ie': 'columbia-col-ie',
  'www.columbiasportswear.it': 'columbia-col-it',
  'www.columbiasportswear.nl': 'columbia-col-nl',
  'www.columbiasportswear.es': 'columbia-col-es',
  'www.columbiasportswear.co.uk': 'columbia-col-uk',
  'www.sorel.at': 'columbia-sor-at',
  'www.sorelfootwear.be': 'columbia-sor-be',
  'www.sorel.fi': 'columbia-sor-fi',
  'www.sorelfootwear.fr': 'columbia-sor-fr',
  'www.sorelfootwear.de': 'columbia-sor-de',
  'www.sorel.ie': 'columbia-sor-ie',
  'www.sorel.it': 'columbia-sor-it',
  'www.sorelfootwear.nl': 'columbia-sor-nl',
  'www.sorelfootwear.es': 'columbia-sor-es',
  'www.sorelfootwear.co.uk': 'columbia-sor-uk'
};

function getTrackingAccount(domain){
  if (typeof accountList[domain] !== "undefined" && (TagManagerData.isInternal === true || TagManagerData.CustomerCareAgent === true)){
   	return 'columbia-us-internal'; 
  }
  else if (TagManagerData.isInternal === false && TagManagerData.SiteID === "Columbia_CN"){
  	return "columbia-col-china";
  }
  else if (TagManagerData.isInternal === false && TagManagerData.SiteID === "Columbia_INT"){
  	return 'columbiaeurope';
  }  
  else if (TagManagerData.isInternal === false && TagManagerData.SiteID === "Sorel_INT"){
  	return 'columbia-sorel-international';
  }
  else if (TagManagerData.SiteID === "MountainHardwear_CA"){
  	return 'columbia-mhw-canada';
  }
  else if (TagManagerData.SiteID === "MountainHardwear_INT"){
  	return 'columbia-mhw-europe';
  }
  else if (typeof accountList[domain] !== "undefined"){
  	return accountList[domain];
  }
  return 'columbia-dw-dev'; 
}

var s_account=getTrackingAccount(window.location.host);
...
s.linkInternalFilters="javascript:,mailto:,scene7.com,"+window.location.host;
...
s.trackingServer="metrics.columbia.com"
s.trackingServerSecure="smetrics.columbia.com"
s.visitorNamespace="columbiasportswear"
s.dc="112"

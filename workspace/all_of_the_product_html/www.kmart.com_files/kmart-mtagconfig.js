...
if(typeof(lpMTagConfig.dynButton)!="undefined") {
	...
	if(document.getElementById("lpSearsDeliveryHeaderChat")) {
        lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {"name":"sears-delivery-header-chat-english","pid":"lpSearsDeliveryHeaderChat","afterStartPage":true,"ovr":"lpMTagConfig.omniInteg"};
    }
	if(document.getElementById("lpSearsDeliveryHeaderVoice")) {
        lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {"name":"sears-delivery-header-voice-english","pid":"lpSearsDeliveryHeaderVoice","afterStartPage":true,"ovr":"lpMTagConfig.omniInteg"};
    }
	if(document.getElementById("lpKmartChatPopupButton")) {
	lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {"name":"kmart-chat-popup-sales-english","pid":"lpKmartChatPopupButton","afterStartPage":true,"ovr":"lpMTagConfig.omniInteg"};
	}
	if(document.getElementById("lpKmartCallPopupButton")) {
		lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {"name":"kmart-voice-popup-sales-english","pid":"lpKmartCallPopupButton","afterStartPage":true,"ovr":"lpMTagConfig.omniInteg"};
	}
	if(document.getElementById("lp-chat-button_member-dashboard")) {
	lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {"name":"sears-mdcancel-chat-service-english","pid":"lp-chat-button_member-dashboard","afterStartPage":true,"ovr":"lpMTagConfig.omniInteg"};
	}
	if(document.getElementById("lp-voice-button_member-dashboard")) {
	lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] =	{"name":"sears-mdcancel-voice-service-english","pid":"lp-voice-button_member-dashboard","afterStartPage":true,"ovr":"lpMTagConfig.omniInteg"};
	}
}
/*##########################  Begin Dynamic Button Code  ####################################*/

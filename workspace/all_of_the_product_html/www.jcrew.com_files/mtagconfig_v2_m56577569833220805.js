...
lpMTagConfig.lpTagSrv = "sr2.liveperson.net";
lpMTagConfig.lpNumber = lp_num;
lpMTagConfig.defaultUnit = lp_unit;
	
try{
	if (typeof(lpUnit)=='undefined'){
		var lpUnit=lpMTagConfig.defaultUnit;
	}
	lpMTagConfig.deploymentID='lp-'+lpUnit;

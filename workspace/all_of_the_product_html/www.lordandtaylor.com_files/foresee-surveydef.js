...
FSR.properties = {
    ...
    invite: {
        ...
        dialogs: [[{
            ...
            blurb: "Thank you for visiting LordandTaylor.com. You have been selected to participate in a brief customer satisfaction survey to let us know how we can improve your experience.",
        ...
        exclude: {
            urls: ['/AjaxOrderItemDisplayView', '/OrderShippingBillingView', '/AjaxLogonForm', '/UserRegistrationForm', '/AccountMyProfileFormView', '/AccountAddressFormView', '/NotificationPreferencesFormView', '/AccountMyOrdersFormView', '/AccountMyWishListFormView'],
            referrers: [],
            userAgents: [],
            browsers: [],
            cookies: [],

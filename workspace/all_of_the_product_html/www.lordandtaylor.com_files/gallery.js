...
MainTopRoll.addItem("","images/detial_big01.jpg");
MainTopRoll.addItem("","images/detial_big02.jpg");
MainTopRoll.addItem("","images/detial_big03.jpg");
MainTopRoll.addItem("","images/detial_big04.jpg");
function color_hbTab(n,j) {
    for (var i = 1; i <= j; i++) {
        if (i == n) {
			//document.getElementById("big" + i).name="IMG_MAIN_TOP_ROLL_DETAIL";
            document.getElementById("color_hbTab" + i).className = "color_ad_Tabopen";
            document.getElementById("gallery_main" + i).style.display = "block";
			MainTopRoll.ListItem.splice(0,MainTopRoll.ListItem.length);
			if(n==1){
				document.getElementById("big1").src = "images/detial_big01.jpg";
				MainTopRoll.addItem("","images/detial_big01.jpg");
				MainTopRoll.addItem("","images/detial_big02.jpg");
				MainTopRoll.addItem("","images/detial_big03.jpg");
				MainTopRoll.addItem("","images/detial_big04.jpg")
			...
			if(n==2){
				document.getElementById("big1").src = "images/detial_red_big01.jpg";
				MainTopRoll.addItem("","images/detial_red_big01.jpg");
				MainTopRoll.addItem("","images/detial_red_big02.jpg");
				MainTopRoll.addItem("","images/detial_red_big03.jpg");
				MainTopRoll.addItem("","images/detial_red_big01.jpg");
			}
			if(n==3){
				document.getElementById("big1").src = "images/detial_red_big01.jpg";
			...
			//document.getElementById("big" + i).name="";
            document.getElementById("color_hbTab" + i).className = "color_ad_Tabclose";

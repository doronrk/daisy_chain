...
$.template( "categoryTemplate", '<div class=""><a href="${u}" name="${n}" class="flyout-navigation-title" ${r}>${l}</a><ul>{{tmpl(items) "itemTemplate"}}</ul></div>' );
...
$(window).load(function(){
	...
	$("#category-navigation-categories li a").hover(createFlyout, function () {});
	$("#shop_all_dept_header").keypress(function(){
		$("#shop_all_dept_header").trigger("click");
	});

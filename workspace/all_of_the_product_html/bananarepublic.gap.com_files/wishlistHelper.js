		...
		insertAddToWishListButton : function(){
			// var temp = setTimeout(function(){
				...
				if(jQuery("#" + skavaWishListHelper.model.SKAVA_ADD_TO_WISHLIST_CONTAINER_ID).length < 1){
					jQuery("#addToBagBtn").after("<div id='" + skavaWishListHelper.model.SKAVA_ADD_TO_WISHLIST_CONTAINER_ID + "' style='float: right;position: relative;margin: -31px 4px 0px 0px;clear: both;'></div>");

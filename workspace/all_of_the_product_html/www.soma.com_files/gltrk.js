/**
 * gltrk.js - v14.06.25.1400.SOMA-mj
 * 
 ...
 default:
    ...
    /** TRUEFFECT COOKIE TAG */
     try
     {
    	...
    	$.cookie("TE_LOYALTY", cookieData, {domain: '.soma.com', path: '/', expires: 3650});
     }
     catch (err)
     {
     ...
     try 
         {  
             if (pageType == "HOME") {
                  ...
                  _struqPI.push(['injectTrackingPixel', { trackingPixelId: 'cwNvm7m0CUGWfkSqqmHC4A', route: '/s/ga/', collectData: false, options: { timeoutMs: 2000, firstPartyCookie: '', firstPartyUid: '' }}]);
                  (function() {
         ...
         {  
              if (pageType == "SHELF") {
                  ...
                  //console.log("gltrk.js - struqFormattedShelfPageProductIds = " + struqFormattedShelfPageProductIds);
	               ...
	               trackingPixelId: '6YPXWEPwM0CRoJKn9CDtlg',
	               route: '/s/sa/',
	               collectData: false,
     ...
     try 
         {  
              if (pageType == "PRODUCT") {
                   window._struqPI = window._struqPI || [];
                   _struqPI.push(['injectTrackingPixel', {
	           trackingPixelId: 'j-6fUzRKxkm2MHmL9j9onA',
	           route: '/s/sa/',
	           collectData: false,
	           /* If you'd like to use JavaScript to pass the dynamic data use the instructions below. Otherwise, change "collectData" above to true and see Implementation guide for the alternative HTML DIV tags.
	              Data required:
     ...
     try 
         {  
              if (pageType == "CART") {
                   window._struqPI = window._struqPI || [];
                   _struqPI.push(['injectTrackingPixel', {
	           trackingPixelId: 'Nk98HmPYSk26PspEjmGBEw',
	           route: '/s/sa/',
	           collectData: false,
	           /* If you'd like to use JavaScript to pass the dynamic data use the instructions below. Otherwise, change "collectData" above to true and see Implementation guide for the alternative HTML DIV tags.
	              Data required:
         ...
         {  
              if (pageType == "ORDER") {
                  ...
                  //console.log("struqOrderProducts = " + struqOrderProducts);
                   ...
                   window._struqPI = window._struqPI || [];
                   _struqPI.push(['injectTrackingPixel', {
	                trackingPixelId: '0gLQogZoUkiqIw8_rsHxPA',
	                route: '/s/cda/', 
	                collectData: false,
        ...
        function magicTwitter() {
            if (pageType == "ORDER") { 
                if (typeof twttr != "undefined") {
                    twttr.conversion.trackPid('l4gal'); 
                }
            } else {
                if (typeof twttr != "undefined") {

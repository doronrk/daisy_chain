...
var s_account='charlotte-russe-dev';
var isProd = document.URL.indexOf('m.charlotterusse.com')>-1 || document.URL.indexOf('www.charlotterusse.com')>-1 || document.URL.indexOf('t.charlotterusse.com')>-1;
if(isProd)
    s_account='charlotte-russe-prod';
...
s.linkInternalFilters='javascript:,.charlotterusse.com,fry.com';
...
s.visitorNamespace='charlotterusse';
s.dc='d1';
if(!isProd)
    s.trackingServer='charlotterusse.d1.sc.omtrdc.net';

/* Uncomment the following if 1st Party SSL Certificate has been installed */
if(isProd){
    s.trackingServer='metrics.charlotterusse.com';
    s.trackingServerSecure='smetrics.charlotterusse.com';
}
...
function s_doPlugins(s) {
    ...
    /* Social Apps SREF */
    if(!s.eVar18)
        s.eVar18=s.getQueryParam('sref,ssfeat');
    s.eVar18=s.getValOnce(s.eVar18,'s_ev18',0);
    ...
    else if(s.eVar18&&s.eVar18!='non-social app')
    {
        s.eVar1='social app';
        s.eVar2='non-search';
        s.eVar3='non-internal campaign';
    ...
    else if(s.events&&s.events.indexOf('purchase')>-1)
    {
        ...
        s.eVar2=s.eVar3=s.eVar4=s.eVar5=s.eVar6=s.eVar7=s.eVar8=s.eVar9=s.eVar18='D=v1';
    }
    ...
    if (!s.eVar32)
        s.eVar32 = s.getQueryParam('RMID');
    s.eVar32 = s.getValOnce(s.eVar32,'s_var_32',0);


    /* Responsys Recipient ID */
    if (!s.eVar33)
        s.eVar33 = s.getQueryParam('RRID');
    s.eVar33 = s.getValOnce(s.eVar33,'s_var_33',0);


    //Registered Vs Guest Users
    if(s.events && (s.events.indexOf('event4')>-1 || s.events.indexOf('event5')>-1)){
        s.eVar36='Registered';
    }else{
        s.eVar36='Guest';
    }

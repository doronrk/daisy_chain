...
//jQuery.js java include from footer for quiick link //////////////////////////////////
...
function changeBackInBlackImages() {
    if (document.images && (preloadFlag == true)) {
        for (var i=0; i<changeBackInBlackImages.arguments.length; i+=2) {
            document[changeBackInBlackImages.arguments[i]].src = changeBackInBlackImages.arguments[i+1];
        }
    }
}
...
window.open(ThePage ,'popup','width=640,height=820,scrollbars=yes');
}


 //getdirection	(from:SEO stores)	
function getdirection(store_Id){
ThePage= 'http://www.apeainthepod.com/MaternityStoreLocatorDirections.asp?id=' + store_Id 
window.open(ThePage ,'popup','width=700,height=700,scrollbars=yes');
...
//////////checkformemail.js for perks email from footer   ////////////////////////////////////////////////////////////////////////////////
...
function checkFormEmail(theForm) {
        ...
        if (perks_email=="") {
			...
			perks_email = perks_email.replace(" ", "");
...
/////////////////checkformemail.js end ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//////////form-field-tooltip.js for perks email from footer & login and checkout  /////////////////////////////////////////////////////////////////////////////
...
function DHTMLgoodies_formTooltip()
{
	...
	this.arrowImageFileRight = 'orange-arrow-right.gif';
	this.tooltipWidth = 200;
	this.tooltipBgColor = '#FF8000'; //'#317082';
	this.closeMessage = 'Close';
	this.disableTooltipMessage = 'Don\'t show these messages again';
...
//////////form-field-tooltip.js end //////////////////////////////////////////////////////////

//////////rounded-corners.js for perks email from footer & login and checkout  ///////////////

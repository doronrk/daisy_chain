...
/* Build Date 12/2/2014 5:01:03 AM */
...
identifiers.SessionID=_ltk.GetCookie("STSID354455");assembler=new _Assembler();assembler.QueryMode=1;assembler.EndPointArray=new Array();assembler.EndPointArray.push('at1.listrakbi.com');assembler.EndPointPath='/Handlers/Set.ashx';assembler.QueryHeader='ctid=4qcIGP5U5equ&uid='+_ltk.uuidCompact()+'&gsid='+_ltk.Session.GlobalID;assembler.AddObject(identifiers);assembler.AddArrayObject(activityArray);assembler.Flush();activityArray.length=0;}
...
_Alerts.prototype.Load=function(){this.MerchantTrackingID='4qcIGP5U5equ';}
...
var modalUID="d7d1fbb0-e284-4eb7-ab25-ae3e38cf9978";var modalSettings={"ModalName":"Modal Acquisition","SuppressionCode":"Modal Acquisition","FollowUpDelay":0,"TriggerOptions":{"TriggerType":0},"DisplayOptions":{"FormHTML":"<div id=\"modal-wrapper\">\r\n    <div id=\"modal-content\"> <a href=\"#\" class=\"ltkmodal-close close-button\">X</a>\r\n        <h1>Stay Connected!</h1>\r\n        <p>Sign up for our email newsletter today and receive a code via email for <strong>20% off</strong>!</p>\r\n        <div class=\"left float-left\">\r\n            <div class=\"field\">\r\n                <input type=\"text\" id=\"ltkmodal-email\" class=\"textbox ltkmodal-email\" name=\"email\" size=\"40\" maxlength=\"100\" value=\"Email Address\"\r\nonfocus=\"if (this.value == 'Email Address') this.value = '';\" onBlur=\"if (this.value == '') this.value = 'Email Address';\" />\r\n            </div>\r\n            <div class=\"field\">\r\n                <input type=\"text\" class=\"textbox\" name=\"Customer Information.First Name\" size=\"40\" maxlength=\"100\" value=\"First Name\"\r\nonfocus=\"if (this.value == 'First Name') this.value = '';\" onBlur=\"if (this.value == '') this.value = 'First Name';\" />\r\n            </div>\r\n            <div class=\"field\">\r\n                <input type=\"hidden\" class=\"text\" name=\"Source.Modal\" size=\"40\" maxlength=\"100\" value=\"On\" />\r\n            </div>\r\n            <div class=\"buttons\">\r\n                <button type=\"submit\" class=\"ltkmodal-subscribe\">Sign Up</button>\r\n                <button type=\"button\" class=\"ltkmodal-close ltkmodal-no-thanks\">No thanks</button>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n<style type=\"text/css\">\r\n#modal-wrapper {\r\n    width: 338px;\r\n    background-color: #fff;\r\n    border: 8px solid #FFFFFF; border-radius: 20px;\r\n    box-shadow: 0px 0px 24px rgba(0,0,0,.75); -webkit-box-shadow: 0px 0px 24px rgba(0,0,0,.75); -moz-box-shadow: 0px 0px 24px rgba(0,0,0,.75);\r\n    font-size: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;\r\n}\r\n#modal-wrapper .close-button {\r\n    position: absolute;\r\n    right: 13px;\r\n    top: 13px;\r\n    display: block;\r\n    background: #e8e1d9;\r\n    color: #fff;\r\n    font-weight: bold;\r\n    line-height: .75em;\r\n    text-align: center;\r\n    font-size: .75em;\r\n    text-decoration: none;\r\n    padding: 3px 3px 6px 6px;\r\n    border-radius-bottom-left: 5px;\r\n    border-bottom-left-radius: 10px;\r\n}\r\n#modal-content {\r\n    background:#fff;\r\n    border: 5px solid #e8e1d9;\r\n    border-radius: 12px;\r\n    font-family: Helvetica, Arial, sans-serif;\r\n    font-size: 14px;\r\n    overflow: hidden;\r\n    padding: 24px;\r\n    text-align: left;\r\n    min-width: 280px;\r\n    max-width: 444px;\r\n    width: 280px;\r\n}\r\n#modal-content input.textbox, #ltkmodal-content select.dropdown {\r\n    display: block;\r\n    height: 28px;\r\n    border: 1px solid #b7b7b7;\r\n    color: #555;\r\n}\r\n#modal-content input.textbox {\r\n    width: 253px;\r\n    padding-left: 5px;\r\n    line-height: 28px;\r\n    vertical-align: middle;\r\n}\r\n#modal-content .select-wrapper {\r\n    width: 258px;\r\n}\r\n#modal-content select {\r\n    width: 100%;\r\n}\r\n#modal-content select option {\r\n    padding-left: 5px;\r\n    line-height: 28px;\r\n    vertical-align: middle;\r\n}\r\n#modal-content label.label {\r\n    cursor: pointer;\r\n    padding-right: 10px;\r\n}\r\n#modal-content input.radio, #modal-content input.checkbox {\r\n    margin-right: 5px;\r\n}\r\n#modal-content .buttons {\r\n    margin-top: 20px;\r\n}\r\n#modal-content h1 {\r\n    color: #ff3399;\r\n    font-size: 24px;\r\n    line-height: 26px;\r\n    margin: 0 0 14px 0;\r\n}\r\n#modal-content p {\r\n    color: #5b1300;\r\n    line-height: 18px;\r\n    margin: 0;\r\n    padding: 0 0 12px 0;\r\n}\r\n#modal-content img {\r\n    border: 0px none;\r\n}\r\n#modal-content .float-left {\r\n    float: left;\r\n}\r\n#modal-content .left {\r\n    width: 290px;\r\n}\r\n#modal-content .field {\r\n    margin: 10px 0;\r\n}\r\n#modal-content button {\r\n    cursor: pointer;\r\n}\r\n#modal-content .ltkmodal-subscribe {\r\n    text-transform: uppercase;\r\n    width: 100px;\r\n    height: 34px;\r\n    line-height: 34px;\r\n    vertical-align: middle;\r\n    text-align: center;\r\n    font-weight: bold;\r\n    background:#ff3399;\r\n    color: #fff;\r\n    border: 0px none; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px;\r\n}\r\n#modal-content .ltkmodal-no-thanks {\r\n    height: 36px;\r\n    line-height: 36px;\r\n    vertical-align: middle;\r\n    text-align: center;\r\n    font-weight: normal;\r\n    background: #fff;\r\n    color: #ff3399;\r\n    border: 0px none;\r\n}\r\n#modal-content .ltkmodal-no-thanks:hover {\r\n    text-decoration: underline;\r\n}\r\n#modal-content .right {\r\n    position: relative;\r\n    margin-left: 24px;\r\n}\r\n#ltkmodal-container {\r\n    top:20% !important;\r\n    left:50% !important;\r\n    margin-left:-169px; /* half the width of #modal-wrapper */\r\n}\r\n</style>","OverlayClose":true,"InitDelay":3},"ActionOptions":{"SubscriberSettingsCode":"Modal","ActionType":0},"ConfirmationOptions":{"ConfHTML":"<div id=\"modal-wrapper\">\r\n    <div id=\"modal-content\"> <a href=\"#\" class=\"ltkmodal-close close-button\">X</a>\r\n        <h1>Thank You!</h1>\r\n        <p>Thank you for subscribing. We will be in touch shortly with your coupon offer email.</p>\r\n        <p>Please <a href=\"#\" class=\"ltkmodal-close\" style=\"color:#ff3399;\">click here</a> to close this window.</p>\r\n    </div>\r\n</div>","RedirURL":"","AutoClose":0},"EligibilityOptions":{"UASuppression":"AndroidPhone,OperaMini,IEMobile,IosIpod,IosIphone","UrlRules":["http://papyrus.listrak.com/*","http://papyrus.listrak.com/iframe.html","/customer/*","/checkout/*","/custom-printing/*","/customizer/*","http://papyrusdev.somethingdigital.com","http://papyrusdev.somethingdigital.com/*"],"TestMode":false,"NewSessionsOnly":true,"UrlRulesMode":2}};_ltk.Modal.add(modalUID,modalSettings);

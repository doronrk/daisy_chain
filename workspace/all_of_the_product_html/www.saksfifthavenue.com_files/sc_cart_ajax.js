...
var sc_cartcoll = 'siteclarity.saksfifthavenue.com';
var sc_cartaff = 'saksfifthavenue';
...
SC_Sku.writeImage=function(a,b,c,d,q) {
    ...
    if(q) {
        ...
        var clarityImageq = document.createElement('img');
        clarityImageq.src = sc_prot + '://' + sc_cartcoll + '/spacer.gif?RN=' + k + '&event=' + p;
        document.body.appendChild(clarityImageq);
        return;
    }
    // get current cookie
    var e=SC_Sku.getCookie_eCommerce(a);
    ...
    var clarityImage = document.createElement('img');
    clarityImage.src = sc_prot+'://'+sc_cartcoll+'/spacer.gif?RN='+k+'&event='+o;
    document.body.appendChild(clarityImage);
}

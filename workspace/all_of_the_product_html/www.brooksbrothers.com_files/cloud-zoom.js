...
(function($) {
    ...
    function CloudZoom(jWin, opts) {
        ...
        this.init = function() {
            $('.cloud-zoom-loading', jWin.parent()).remove();
            $mouseTrap = jWin.parent().append(format("<div class='mousetrap' style='background-image:url("+app.urls.staticPathSpacerGif+");z-index:190;position:absolute;width:%0px;height:%1px;left:%2px;top:%3px;\'></div>", sImg.outerWidth(), sImg.outerHeight(), 0, 0)).find(':last');
            ...
            $mouseTrap.bind('mouseenter', this, function(event) {
                ...
                $mouseTrap.css('cursor', 'url(' + app.urls.staticPathZoomCursorPng + '), url(' + app.urls.staticPathZoomCursorCur + '), move');
                var noTrans = false;
                if (opts.tint) {

...
FSR.properties = {
    ...
    invite: {
        ...
        dialogs: [[{
            reverseButtons: false,
            headline: "We'd welcome your feedback!",
            blurb: "Thank you for visiting PacSun.com. You have been selected to participate in a brief customer satisfaction survey to let us know how we can improve your experience.",
        ...
        exclude: {
            urls: ['/on/demandware.store/Sites-pacsun-Site/default/51Checkout-Envoy30'],
            referrers: [],
            userAgents: [],
            browsers: [],
            cookies: [],
    ...
    events: {
        ...
        custom: {
            purchase: {
                ...
                repeat: false,
                source: 'variable',
                name: 'utag_data.order_grandTotal'
            },
			items: {
                enabled: true,
                repeat: false,
                source: 'variable',
                name: 'utag_data.product_quantity'
            },
			dollars: {
                enabled: true,
                repeat: false,

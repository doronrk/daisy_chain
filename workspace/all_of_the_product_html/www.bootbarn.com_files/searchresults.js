			...
			bindClickToAllRefineLinks : function() {
				...
				*/
				...
				jQuery("div.refineattributes ul li a").click(function(e) {
					...
					//return false; we use no ajax atm
				});
			...
			SearchResult : function(keywordSearch, categoryID)
			{
				...
				this.bindToggleEvent = function(dwRefinement)
				{
					jQuery("#"+dwRefinement.id+" h3").click(function(e) {
						...
						jQuery(this).parent.nextAll("div.refineattributes").toggle();
					});
				};
				...
				this.updateValues = function(dwRefinement)
				{
					...
					for(var i=0; i<dwRefinement.values.length; i++)
					{
						...
						var listEntry  = "<li" + (liClass != null ? " class=\"" + liClass + "\"" : "") + ">";
							listEntry += "<a " + (aID != null ? " id=\"" + aID + "\"" : "");
							listEntry += " class=\"" + aClass + "\" " + (aUrl != null ? " href=\"" + aUrl + "\"" : "") + ">";
							listEntry += value.displayValue
							listEntry += "<\/a><\/li>";
						
						jQuery("#"+dwRefinement.id+" ul" + (listElemID != "" ? "#" + listElemID : "")).append(listEntry);
					}
...
jQuery(document).ready(function() {
	...
	jQuery("#searchrefinements .refinementheader").click(function(e) {
		jQuery(this).children(".refinementarrow").toggleClass("collapsed");

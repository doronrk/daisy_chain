...
wcsbLoadImage('https://www.dsply.com/index.php?pid=rv4a0pklnx&e=product-detail-page-view&site=brandsmartusa&cpi='+escCpi+'&localtimestamp='+timestamp+'');
}
}
function wcsbGetCpi ()
{
...
{
setTimeout(wcsbSa, 1);
wcsbLoadScript('http://content.webcollage.net/brandsmartusa/smart-button?ird=true&channel-product-id=' + encodeURIComponent(wcsbGetCpi()), 'wcsb-auto');
}

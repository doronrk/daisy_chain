...
bouncex.website = {"cae":false,"ei":1,"cookie_name":"bounceClientVisit1024","base_host":"bounceexchange.com","vars":{"75_minus_cart":{"polling":"all","persist":"no","val":"(75 - (parseFloat(jQuery('.value').text().trim().replace('$', '')))).toFixed(2)","default":"75"},"ever_logged_in":{"polling":"none","persist":"permanent","val":"bouncex.vars.ever_logged_in || !\/customer=none\/.test(document.cookie);","default":"false"}},"acts":[],"pi":1000,"ct":"bind_to_domain","tcjs":"","cjs":"","PMI":500,"PDI":1000,"PMR":30,"force_https":false,"waypoints":false,"gai":"","ots":0,"sd":0,"aco":{"first_party_limit":"3500"},"id":1024,"campaign_id":0,"tpc":0,"uwc":1,"domain":"store.delias.com","bau":"api.bounceexchange.com","is_preview":false,"mas":2,"map":1,"burls":[],"ibx":{"cjs":"","miw":"0","mibcx":0,"te":0,"tjs":"","cart_rep":{"get":"","set":""}}};

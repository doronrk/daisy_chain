		...
		insertAddToWishListButton : function(){
			// var temp = setTimeout(function(){
				...
				if(jQuery("#" + skavaWishListHelper.model.SKAVA_ADD_TO_WISHLIST_CONTAINER_ID).length < 1){
					jQuery("#addToBagBtn").after("<div id='" + skavaWishListHelper.model.SKAVA_ADD_TO_WISHLIST_CONTAINER_ID + "' style='margin:-30px 3px 0px 0px;clear:both;float:right;'></div>");
					jQuery("#quantityContent").css("height","60px");
				}
			// },1500);
		},
...
if(myWishlistHelperSegmenter.QuickSegment.toLowerCase() == "b" || location.pathname == "/profile/sign_in.do" || location.pathname == "/profile/sign_out.do"){

...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		{	// Construct our Lightbox
			...
			if ( $.Lightbox && (domReady || typeof options.download_link !== 'undefined' ||  typeof options.colorBlend !== 'undefined' || typeof options.files === 'object' || typeof options.text === 'object' || typeof options.show_linkback !== 'undefined' || typeof options.scroll_with !== 'undefined') )
		...
		domReady: function ( )
		{
			...
			/* DJL - do not show the "Hover to interact" div at all.
			...
			*/
			...
			// Image link
			if (this.download_link) $('#lightbox-caption-title').click(function(){window.open($(this).attr('href')); return false;});
		...
		{	// Resize the boxes
			...
			{	// We don't care for transition
				var $body = $(this.ie6 ? document : document);
				$('#lightbox-overlay').css({
					width:		$body.width(),
					height:		$body.height()
				});
		...
		repositionBoxes: function ( options )
		{
			...
			if (this.ie6) {
				$('#lightbox-overlay-text').css({ top: pageScroll.yScroll });
			}
		...
		showImage: function ( image, step )
		{
			...
			switch ( step )
			{
				...
				case 4:
					...
					// Apply event - DJL - do not apply the event - never show the footer for our purposes.
/*
...
})(dmJQuery); // We are done with our plugin, so lets call it with jQuery as the argument

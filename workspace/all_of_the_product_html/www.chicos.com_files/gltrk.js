/**
 * gltrk.js - v14.06.25.1400.CHS-mj
 *
...
function getShelfPageProductIds() {
    ...
    if((numPC1>0)&&(numPC2>0)){
        ...
        //console.log('number of products on this page = ' + numberOfProductCapsules);

        for (var i=1; i <= numberOfProductCapsules; i++) {
            //console.log('gltrk.js -- i = ' + i);
            var thisPCsHTML = "";
            if ((typeof document.getElementById('pc' + i) !== "undefined") && (document.getElementById('pc' + i) != "") && (document.getElementById('pc' + i) != null)) {
            ...
            } else { console.log('this product capsule is failing: product capsule # ' + i); }
        }
    }
...
try
{
    ...
    if (isHomePage > 1) {
        document.write('\x3Cscript SRC="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Homepage&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
    } //end if
} //end try
catch (err)
{
        ...
        switch(glCatId) {
            case "cat40036":
                ...
                switch(glSubCatId)
                {
                    case "cat7639278":
                        //So Slimming
                        document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=So_Slimming&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                        break;
                    default:
                        //top category (NEW ARRIVALS)
                        document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=New_Arrivals&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                }	//end switch
                break;
            case "cat40010":
                //Travelers
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Travelers&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat7059275":
                //Black Label
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Black_Label&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat40001":
                //Jackets
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Jackets&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat2580017":
                //Zenergy
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Zenergy&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat40002":
                //Tops
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Tops&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat8289646":
                //Pants Denim
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Pants_Denim&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat40004":
                //Dresses Skirts
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Dresses_Skirts&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat40005":
                //Jewelry
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Jewelry&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "cat40006":
                //Accessories
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Accessories&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            default:
        } //end switch
    }//end if
...
try
{
    if (pageType == "SEARCH") {
        switch(glCatId) {
            case "cat4809275":
                //Sale
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Sale&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            default:
        } //end switch
    } //end if
...
try
{
    if (pageType == "PAGE") {
        switch(pageId) {
            case "97":
                //Email Signup
                document.write('\x3Cscript src="https://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Email_SignUp&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
                break;
            case "70409282":
                //Black Label
                document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Black_Label&revenue=REVENUE&random=' + CACHEBUSTER + '">\x3C/script>');
...
{
    if (pageType == "CART") {
        document.write('\x3Cscript src="http://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Shopping_Cart&revenue=' + cartSubTotal + '&random=' + CACHEBUSTER + '">\x3C/script>');
    } //end if
} //end try
catch (err)
{
...
{
    if (pageType == "ORDER") {
        document.write('\x3Cscript SRC="https://webmedia.chicos.com/jpixel?spacedesc=9550308_1061349_1x1_1061349_1061349&db_afcr=123&target=_blank&group=Chicos&event=Check_Out&revenue=' + checkOutSubTotal + '&random=' + CACHEBUSTER + '&x_order_id=' +checkOutOrderID + '&x_uid=USERID">\x3C/script>');
    } //end if
} //end try
catch (err)
{
...
try
{
    if (pageType == "HOME") {
        ...
        _struqPI.push(['injectTrackingPixel', { trackingPixelId: 'KIJ1nTx47EmhlphhW_eIWw', route: '/s/ga/', collectData: false, options: { timeoutMs: 2000, firstPartyCookie: '', firstPartyUid: '' }}]);
        (function() {
...
try
{
    if (pageType == "SHELF") {
        ...
        _struqPI.push(['injectTrackingPixel', {
            trackingPixelId: 'pno1iRGOtEey_D_Y4CRUFQ',
            route: '/s/sa/',
            collectData: false,
...
try
{
    if (pageType == "PRODUCT") {
        window._struqPI = window._struqPI || [];
        _struqPI.push(['injectTrackingPixel', {
            trackingPixelId: 'IVCTPn7Vg0KNw0mSNuiyGQ',
            route: '/s/sa/',
            collectData: false,
            /* If you'd like to use JavaScript to pass the dynamic data use the instructions below. Otherwise, change "collectData" above to true and see Implementation guide for the alternative HTML DIV tags.
             Data required:
...
try
{
    if (pageType == "CART") {
        window._struqPI = window._struqPI || [];
        _struqPI.push(['injectTrackingPixel', {
            trackingPixelId: 'B_k0K_mBekesehMSK44YnQ',
            route: '/s/sa/',
            collectData: false,
            /* If you'd like to use JavaScript to pass the dynamic data use the instructions below. Otherwise, change "collectData" above to true and see Implementation guide for the alternative HTML DIV tags.
             Data required:
...
try
{
    if (pageType == "ORDER") {
        ...
        window._struqPI = window._struqPI || [];
        _struqPI.push(['injectTrackingPixel', {
            trackingPixelId: 'gHZnooPcr0eHGKf0Z_xrGw',
            route: '/s/cda/',
            collectData: false,
...
try {
    if (pageType == "ORDER") {
        ...
        CJ.config = {
            ...
            CID: '1528037',
            BASE_URL_TEMPLATE: 'https://{0}/u?CID={1}&OID={2}&TYPE=362542{3}&CURRENCY=USD&METHOD=IMG',
        ...
        function magicTwitter() {
            if (pageType == "ORDER") { 
                if (typeof twttr != "undefined") {
                    twttr.conversion.trackPid('l4gah');
                }
            } else {
                if (typeof twttr != "undefined") {

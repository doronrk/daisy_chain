 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'http://kingwebmaster.com.p12.hostingprod.com/lightbox/lightbox-ico-loading.gif',imageBtnPrev:'http://kingwebmaster.com.p12.hostingprod.com/lightbox/lightbox-btn-prev.gif',imageBtnNext:'http://kingwebmaster.com.p12.hostingprod.com/lightbox/lightbox-btn-next.gif',imageBtnClose:'http://kingwebmaster.com.p12.hostingprod.com/lightbox/lightbox-btn-close.gif',imageBlank:'http://kingwebmaster.com.p12.hostingprod.com/lightbox/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
...
while(curDate-date<ms);};return this.unbind('click').click(_initialize);};})(jQuery);function bannerRot(dir){
	if (dir == left){
		document.getElementById('kwm_image_rotator')	
	}
}
	...
	function kwm_img_rotator(){
		...
		var create_image_rotator = function(images){
			...
			for(i = 0, len = images[3].length; i < len; i++){
				...
				img.src = images[3][i];
				img.style.cssText = 'position: absolute; top: 0; left: 0; cursor: pointer; z-index: 0;';
				img.style.height = parseInt(self.ir.style.height) + 'px';
				img.style.width = parseInt(self.ir.style.width) + 'px';
				img.showing = false;
				set_opacity(0, img);
				img.opacity = 0;
				if(images[4][i] !== undefined){
					var url = images[4][i];
					img.url = url;
					delete url;
				}
				img.onclick = (function(s){
					return function(e){
						...
						location.href = s.images[s.current_image].url;
						s.kill_event(e);
					};
				})(self);

...
/***********************************************************************************/	
	if(!s.campaign && s.campaignID)
		s.campaign=s.getValOnce(s.getQueryParam(s.campaignID),'zalescmp');

/*Capture Responsys Tracking Code and Recipient ID*/
/***********************************************************************************/	
	if(!s.eVar41)
		s.eVar41=s.getValOnce(s.getQueryParam('camp'),'zalescmp1');

	if(!s.eVar42)
		s.eVar42=s.getValOnce(s.getQueryParam('riid'),'zalescmp2');
...
/*Stacking different campaigns against each other for attribution analysis*/
/**********************************************************************/

	//s.crossVisitParticipation(s.eVar43,'s_zalesvpc', '30', '5', ' > ', 'purchase');

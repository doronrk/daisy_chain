//tealium universal tag - utag.317 ut4.0.201410211719, Copyright 2014 Tealium.com Inc. All Rights Reserved.
var s_account="demandeasyspiritprod";var s=s_gi(s_account);s.dynamicAccountSelection=true;s.dynamicAccountList="demandeasyspiritdev=int.easyspirit.com,staging2.easyspirit.com";s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters="Javascript;";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="USD";s.visitorNamespace="demandware";s.trackingServer="vitals.easyspirit.com";s.trackingServerSecure="svitals.easyspirit.com";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.26';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(s.rep(m,\"\\\\\",\"\\\\\\"
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1,'video':1};u.o=s;u.varlist={pageName:'pageName',channel:'ch',campaign:'v0',hier1:'h1',hier2:'h2',hier3:'h3',hier4:'h4'};for(var i=1;i<76;i++){u.varlist['prop'+i]='c'+i;u.varlist['eVar'+i]='v'+i};u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)};u.map={"page_name":"pageName","search_term":"prop4,eVar4","search_results":"prop5,eVar5","order_id":"eVar17","order_payment_type":"eVar8","site_section":"eVar1,channel","site_subsection":"prop1","internal_promotion":"prop2,eVar2","advanced_internal_search":"prop3,eVar3","error_value":"prop9","merchandising_channel_lvl1":"eVar9","merchandising_channel_lvl2":"eVar10","dom.url":"prop7","dom.domain":"prop8","facet_navigation":"prop6,eVar6","product_sku":"PRODUCTS_id","order_tax":"PRODUCTS_event24","potential_product_price":"PRODUCTS_event21","potential_product_quantity":"PRODUCTS_event22","quickview_product":"eVar14"};u.extend=[function(a,b){if(b['page_name'].toString().toLowerCase().indexOf('no results'.toLowerCase())>-1){b['search_term']=b['qp.q'];b['search_results']='0'}},function(a,b){b._ccat=[];},function(a,b){if(1){try{b['sc_events']=u.addEvent(b.custom_omn_events);}catch(e){}}},function(a,b){s.crossVisitParticipation=new Function("v","cn","ex","ct","dl","ev","dv",""
...
+"m:dl});if(ce)s.c_w(cn,'');return r;");s.getNewRepeat=new Function("d","cn",""
...
+"epa(v)}return ''");s.socialPlatforms=new Function("a",""
...
+"ialauthor']=s.user;}}");s.socialAuthorSearch=new Function("obj",""
+"var s=this;if(typeof obj==='undefined'||typeof obj.author==='undefi"
+"ned'){s.user='Not Found';}else{s.user=obj.author;}s.Integrate.Socia"
+"lAuthor.ready();");s.m_Integrate_c="var m=s.m_i('Integrate');m.add=function(n,o){var m=this,p;if(!o)o='s_Integrate_'+n;if(!m.s.wd[o])m.s.wd[o]=new Object;m[n]=new Object;p=m[n];p._n=n;p._m=m;p._c=0;p._d=0;p.disable=0;p"
...
+"cript=function(u){var p=this,m=p._m;if(!p.disable)m.s.loadModule(0,m._fu(p,u),0,1)};m.l=new Array;if(m.onLoad)m.onLoad(s,m)";s.m_i("Integrate");},function(a,b){s.maxDelay='3000';s.loadModule("Integrate")
s.Integrate.onLoad=function(s,m){s.socialAuthors();};s.usePlugins=true;window.s_doPlugins=function(s){s.prop11=s.getNewRepeat(30,'s_getNewRepeat');s.campaign=s.getQueryParam('ep_tag');s.socialPlatforms();}
s.doPlugins=s_doPlugins},function(a,b){if((typeof b['order_id']!='undefined'&&typeof b['order_id']!='undefined'&&b['order_id']!='')){try{b['sc_prodevents']=u.addProduct(";shipping;1;"+b.order_shipping+";event25="+b.order_shipping)}catch(e){}}}];u.send=function(a,b,c,d,e,f,g,h,ev){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:317");u.data={};u.a=a;b.sc_events=b.sc_events||{};u.addEvent=function(v,n){var t=[];if(v instanceof Array){t=v.slice(0);}else if(typeof n!="undefined"){t.push(v+"="+n);}else{t.push(v);}
...
utag.DB("send:317:COMPLETE");}}
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('317','thejonesgroup.easyspirit');}catch(e){};
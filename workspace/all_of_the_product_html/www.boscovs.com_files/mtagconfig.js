...
// LP Button Code
//replaced by lpbchatbuttondivsmall
//lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-' + lpUnit,'pid':'lpbchatbuttondiv','afterStartPage': true};
//replace by lpchatbuttondivbig
//lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-' + lpUnit +'-2' ,'pid':'lpbchatbuttondiv2','afterStartPage': true};
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-' + lpUnit +'-small' ,'pid':'lpbchatbuttondivsmall','afterStartPage': true};
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = {'name':'chat-' + lpUnit +'-big' ,'pid':'lpbchatbuttondivbig','afterStartPage': true};
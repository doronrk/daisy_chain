//tealium universal tag - utag.6 ut4.0.201406260945, Copyright 2014 Tealium.com Inc. All Rights Reserved.
var s_account="bdsprod";var s=s_gi(s_account);s.dynamicAccountSelection=true;s.dynamicAccountList="bdsdev=wwwp.boscovs.com,ltecadm1.boscov.com,giftregtest.boscov.com,mstage.boscovs.com,mstage.wwwp.boscovs.com;bdsprod=www.boscovs.com,lxecadm1.boscov.com,giftregistry.boscovs.com,m.boscovs.com";s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters="javascript:,boscovs.com,boscov.com,ltecadm1.boscov.com,lxecadm1.boscov.com,m.boscovs.com";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="USD";s.visitorNamespace="boscovs";s.trackingServer="boscovs.d1.sc.omtrdc.net";s.trackingServerSecure="boscovs.d1.sc.omtrdc.net";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.26';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(s.rep(m,\"\\\\\",\"\\\\\\"
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1,'video':1};u.o=s;u.varlist={pageName:'pageName',channel:'ch',campaign:'v0',hier1:'h1',hier2:'h2',hier3:'h3',hier4:'h4'};for(var i=1;i<76;i++){u.varlist['prop'+i]='c'+i;u.varlist['eVar'+i]='v'+i};u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)};u.map={"page_name":"pageName","sc_page_hier":"hier1,channel,eVar7,eVar25","event_type:cart_remove":"scRemove","event_type:cart_add":"scAdd","event_type:search_null":"event2","event_type:search_null_related":"event3","event_type:account_login":"event4","event_type:account_create":"event5","event_type:account_update":"event6","event_type:order":"event9","event_type:product_social":"event10","event_type:video_launch":"event11","event_type:download_pdf":"event12","event_type:contact_us":"event13","event_type:click_to_chat":"event14","event_type:credit_card_more_info":"event15","link_name":"link_name","page_level1":"prop1","page_level2":"prop2","page_level3":"prop3","page_level4":"prop4","page_level5":"prop5","page_level6":"prop6","page_level7":"prop7","search_keyword":"prop8,eVar2","new_or_repeat":"eVar11","search_results":"prop12","page_type":"prop13","page_type:search":"event1","page_type:cart":"scView","page_type:product":"prodView","page_type:bundle":"prodView","social_share_type":"eVar15","video_link":"eVar16","sc_repeat_pathing":"prop17","billing_state":"state,eVar17","billing_postal_code":"zip,eVar18","order_payment_type":"eVar19","download_file_name":"eVar20","page_url":"prop20,eVar21","shipping_postal_code":"eVar22","shipping_state":"eVar23"};u.extend=[function(a,b){s.usePlugins=true
function s_doPlugins(s){var url=s.downloadLinkHandler();if(url){var currentobj=s.eo?s.eo:s.lnk;if(currentobj&&currentobj.innerHTML){s.eVar20=currentobj.innerHTML;}else{s.eVar20=url;}
s.events="event12";s.linkTrackVars="eVar20";}
pathAndSearch=location.pathname+location.search;pathAndSearch.replace("/StoreFrontWeb","");pathAndSearch.length>100?s.prop20=pathAndSearch.substring(0,100):s.prop20=pathAndSearch;s.server=location.host;var aCid=[];var cid_tracking="";if(s.getQueryParam('cm_mmc')){aCid.push(s.getQueryParam('cm_mmc'));}
if(s.getQueryParam('cm_ven')){aCid.push(s.getQueryParam('cm_ven'));}
if(s.getQueryParam('cid')){aCid.push(s.getQueryParam('cid'));}
if(s.getQueryParam('AFL')){aCid.push(s.getQueryParam('AFL'));}
if(s.getQueryParam('CSE')){aCid.push(s.getQueryParam('CSE'));}
if(s.getQueryParam('BAN')){aCid.push(s.getQueryParam('BAN'));}
if(s.getQueryParam('PPC')){aCid.push(s.getQueryParam('PPC'));}
if(s.getQueryParam('SEO')){aCid.push(s.getQueryParam('SEO'));}
if(s.getQueryParam('DIR')){aCid.push(s.getQueryParam('DIR'));}
if(s.getQueryParam('REF')){aCid.push(s.getQueryParam('REF'));}
if(s.getQueryParam('SOC')){aCid.push(s.getQueryParam('SOC'));}
if(s.getQueryParam('SBP')){aCid.push(s.getQueryParam('SBP'));}
if(s.getQueryParam('RET')){aCid.push(s.getQueryParam('RET'));}
if(s.getQueryParam('MPL')){aCid.push(s.getQueryParam('MPL'));}
if(aCid.length>0){cid_tracking=aCid.join("");s.campaign=cid_tracking;}
s.eVar21=s.prop20;var totalDate=new Date();var year=totalDate.getFullYear();s.prop14=s.eVar8=s.getTimeParting('h','-5',year);s.prop15=s.eVar9=s.getTimeParting('d','-5',year);s.prop16=s.eVar10=s.getTimeParting('w','-5',year);s.eVar12=s.prop18=s.getVisitNum();s.prop19=s.eVar13=s.getDaysSinceLastVisit('s_lv');if(s.getQueryParam('rmid'))s.campaign='Responsys';if((s.getQueryParam('source')=='cj')||(s.getQueryParam('source')=='pjn'))s.campaign=s.getQueryParam('source');if(s.eVar2)
{s.events=s.apl(s.events,'event1',',',2);if(s.prop12&&(s.prop12=='0'||s.prop12=='zero'))
{s.prop12='zero';s.events=s.apl(s.events,'event2',',',2);}}
var t_search=s.getValOnce(s.eVar2,'s_stv',0);if(t_search=='')
{var a=s.split(s.events,',');var e='';for(var i=0;i<a.length;i++)
{if(a[i]=='event1'||a[i]=='event2'||a[i]=='event3')
continue;else
e+=a[i]?a[i]+',':a[i];}
s.events=e.substring(0,e.length-1);}
if((s.events)&&(s.events.indexOf('prodView')>-1))
s.events=s.apl(s.events,'event20',',',2);var firstPage=false
firstPage=s.getVisitStart("s_visit");var internalFlag=false;if(document.referrer)
...
{s.eVar6='external campaign referral';s.eVar24='non-search';s.eVar1='non-internal campaign';s.eVar25='non-browse';}
else if(document.referrer&&!internalFlag)
{s.eVar6='external natural referral';s.eVar24='non-search';s.eVar1='non-internal campaign';s.eVar25='non-browse';}
else if(document.referrer&&internalFlag&&(s.eVar2)&&s.eVar24!='non-search')
{if(s.events.indexOf('event1',0)>-1){s.eVar6='internal keyword search';s.eVar1='non-internal campaign';s.eVar25='non-browse';s.eVar24=s.eVar2;s.events=s.apl(s.events,"event16",",",2);}
else if(!s.events.indexOf('event1',0)>-1){s.eVar6=s.eVar1=s.eVar25=s.eVar24='';}
if(s.events.indexOf('event2',0)>-1)s.events=s.apl(s.events,"event17",",",2);if(s.events.indexOf('event3',0)>-1)s.events=s.apl(s.events,"event18",",",2);}
else if(!document.referrer&&(firstPage==0)&&(s.eVar2)&&s.eVar24!='non-search')
{if(s.events.indexOf('event1',0)>-1){s.eVar6='internal keyword search';s.eVar1='non-internal campaign';s.eVar25='non-browse';s.eVar24=s.eVar2;s.events=s.apl(s.events,"event16",",",2);}
else if(!s.events.indexOf('event1',0)>-1){s.eVar6=s.eVar1=s.eVar25=s.eVar24='';}
if(s.events.indexOf('event2',0)>-1)s.events=s.apl(s.events,"event17",",",2);if(s.events.indexOf('event3',0)>-1)s.events=s.apl(s.events,"event18",",",2);}
else if(s.eVar1&&s.eVar1!='non-internal campaign')
{s.eVar6='internal campaign';s.eVar24='non-search';s.eVar25='non-browse';}
else if(s.eVar25&&s.eVar25!='non-browse')
{s.eVar6='browse';s.eVar24='non-search';s.eVar1='non-internal campaign';}
else if((s.events)&&(s.events.indexOf('purchase',0)>-1))
{s.eVar6='unknown at time of purchase';s.eVar1=s.eVar24=s.eVar25='D=v6';}
else if(s.eVar6)
{s.eVar24='non-search';s.eVar1='non-internal campaign';s.eVar25='non-browse';}
if(s.eVar6||s.eVar1||s.eVar24||s.eVar25)
{if(!s.products)
s.products=";"
s.linkTrackVars=s.apl(s.linkTrackVars,'products',',',2);s.linkTrackVars=s.apl(s.linkTrackVars,'event',',',2);s.linkTrackEvents=s.apl(s.linkTrackEvents,'event19',',',2);s.events=s.apl(s.events,'event19',',',2);}
}
s.doPlugins=s_doPlugins;},function(a,b){s.getVisitStart=new Function("c",""
+"var s=this,v=1,t=new Date;t.setTime(t.getTime()+1800000);if(s.c_r(c"
+")){v=0}if(!s.c_w(c,1,t)){s.c_w(c,1,0)}if(!s.c_r(c)){v=0}return v;");s.apl=new Function("L","v","d","u",""
+"var s=this,m=0;if(!L)L='';if(u){var i,n,a=s.split(L,d);for(i=0;i<a."
+"length;i++){n=a[i];m=m||(u==1?(n==v):(n.toLowerCase()==v.toLowerCas"
+"e()));}}if(!m)L=L?L+d+v:v;return L");s.downloadLinkHandler=new Function("p",""
+"var s=this,h=s.p_gh(),n='linkDownloadFileTypes',i,t;if(!h||(s.linkT"
+"ype&&(h||s.linkName)))return '';i=h.indexOf('?');t=s[n];s[n]=p?p:t;"
+"if(s.lt(h)=='d')s.linkType='d';else h='';s[n]=t;return h;");s.getDaysSinceLastVisit=new Function("c",""
...
+"t;");s.getValOnce=new Function("v","c","e",""
...
+"epa(v)}return ''");},function(a,b){if(1){try{b['new_or_repeat']=s.getNewRepeat(365)}catch(e){}}},function(a,b){if(typeof b['_page_levels']!='undefined'&&b['_page_levels']!=''){try{b['sc_page_hier']=b._page_levels.join(':')}catch(e){}}},function(a,b){if(typeof b['order_id']!='undefined'){b['billing_postal_code']=b['shipping_postal_code'];b['billing_state']=b['shipping_state']}},function(a,b,c,d){if((typeof b['sc_page_hier']!='undefined'&&typeof b['new_or_repeat']!='undefined')){c=[b['new_or_repeat'],b['page_type'],b['sc_page_hier']];b['sc_repeat_pathing']=c.join(':')}},function(a,b,c,d){if((typeof b['sc_page_hier']=='undefined'&&typeof b['new_or_repeat']!='undefined')){c=[b['new_or_repeat'],b['page_name']];b['sc_repeat_pathing']=c.join(':')}},function(a,b){if((typeof b['search_keyword']!='undefined'&&typeof b['search_keyword']!='undefined'&&b['search_keyword']!='')){try{b['search_keyword']=b.search_keyword.toLowerCase()}catch(e){}}},function(a,b,c,d){if(b['event_type']=='product_social'){c=[b['page_name'],b['event_name'],b['social_share_type']];b['link_name']=c.join(':')}},function(a,b){if(b['event_type']=='click_to_chat'){try{b['link_name']=b.page_name+':Click to Chat'}catch(e){}}},function(a,b){if(b['event_type']=='account_login'){try{b['link_name']=b.page_name+':login'}catch(e){}}},function(a,b){if(b['event_type']=='cart_add'){try{b['link_name']='scAdd:'+b.page_name}catch(e){}}},function(a,b){if((b['event_type']=='cart_remove'&&typeof b['event_name']!='undefined')){try{b['link_name']=b.page_name+':'+b.event_name}catch(e){}}},function(a,b){if(b['event_type']=='credit_card_more_info'){try{b['link_name']=b.page_name+':'+b.event_name}catch(e){}}},function(a,b){if(b['event_type']=='checkout_shipbill'){try{b['sc_events']=u.addEvent(['scCheckout','event7'])}catch(e){}}},function(a,b){if(b['event_type']=='order_review'){try{b['sc_events']=u.addEvent(['event8'])}catch(e){};try{b['page_name']=b.page_name+':Billing Submitted:'+(b.order_payment_type||'unknown')}catch(e){}}}];u.send=function(a,b,c,d,e,f,g,h,ev){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:6");u.data={};u.a=a;b.sc_events=b.sc_events||{};u.addEvent=function(v,n){var t=[];if(v instanceof Array){t=v.slice(0);}else if(typeof n!="undefined"){t.push(v+"="+n);}else{t.push(v);}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('6','boscovs.main');}catch(e){};
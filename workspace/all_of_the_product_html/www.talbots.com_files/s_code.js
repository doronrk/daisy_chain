...
s.trackingServer="metrics.talbots.com"
s.visitorNamespace="talbots"
s.trackingServerSecure="smetrics.talbots.com"
...
s.linkInternalFilters="javascript:,talbots.com,localhost,cheetahmail.com,talbotsoutlet.com,talbotsinc.com,talbots.ca,talbotskids.com,talbotspetite.com,ecommwebprd,talbotsclothes.com,talbotswomen.com,macromedia.com,ebm.cheetahmail.com,reg.cheetahmail"
...
/* You may insert any plugins you wish to use here.                 */
	...
	function scProdQuickView(obj,prodId,merCat){
		var s = s_gi(s_account);
	...
	//This function will be called when add to cart event happening from quick view
	function scQuickViewCartAdd(obj,prodId,skuId,cartStatus){
		var s = s_gi(s_account);
		...
		s.tl(obj,'o','quick view cart add');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.products='';
	...
	//This function will be called when add to wishlist event happening from quick view
	function scQuickViewWishlistAdd(obj,prodId,skuId,wishlistStatus){
		var s = s_gi(s_account);
		s.linkTrackVars='events,products,eVar4';
		if(wishlistStatus == 0){
		...
		s.products=';' + prodId + ';;;;evar4=' + skuId;
		s.tl(obj,'o','product details wishlist add');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.products='';
	...
	//This function will be called when add to cart event happening from product details
	function scProductDetailsCartAdd(obj,prodId,skuId,cartStatus){
		var s = s_gi(s_account);
		s.linkTrackVars='events,products,eVar4';
		if(cartStatus == 0){
			s.linkTrackEvents='scOpen,scAdd';
		...
		s.products=';' + prodId + ';;;;evar4=' + skuId;
		s.tl(obj,'o','product details cart add');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.products='';
	...
	//This function will be called when add to wishlist event happening from product details
	function scProductDetailsWishlistAdd(obj,prodId,skuId,wishlistStatus){
		var s = s_gi(s_account);
		s.linkTrackVars='events,products,eVar4';
		if(wishlistStatus == 0){
			s.linkTrackEvents='event7,event8,event34';
	...
	//This function will be called when add to cart event happening from category list page
	function scCategoryListCartAdd(obj,prodId,skuId,cartStatus){
		var s = s_gi(s_account);
		s.linkTrackVars='events,products,eVar4';
		if(cartStatus == 0){
			s.linkTrackEvents='scOpen,scAdd';
		...
		s.products=';' + prodId + ';;;;evar4=' + skuId;
		s.tl(obj,'o','category list cart add');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.products='';
	...
	//This function will be called when product tool used
	function scProductToolOpen(obj,prodId){
		var s = s_gi(s_account);
		s.linkTrackVars='events,products,pageName,channel,prop2,prop3,prop4';
		s.linkTrackEvents='event14';
		s.events='event14';
		s.products=';' + prodId;
		s.pageName='product view tool';
		s.channel='product view tool';
		s.prop2='product view tool';
		s.prop3='product view tool';
		s.prop4='product view tool';
		s.tl(obj,'o','product view tool open');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.products='';
	...
	function scClickToChat(obj){
		var s = s_gi(s_account);
		s.linkTrackVars='events,eVar17';
		s.linkTrackEvents='event12';
		s.events='event12';
		s.eVar17="click to chat";
		s.tl(obj,'o','click to chat');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.eVar17='';
	...
	function scClickToCall(obj){
		var s = s_gi(s_account);
		s.linkTrackVars='events,eVar17';
		s.linkTrackEvents='event12';
		s.events='event12';
		s.eVar17="click to call";
	...
	//This function will be called when user sign up for email
	function scEmailSignUp(obj){
		var s = s_gi(s_account);
		s.linkTrackVars='events,eVar17';
		s.linkTrackEvents='event12';
		s.events='event12';
		s.eVar17='email';
		s.tl(obj,'o','email signup');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.eVar17='';
	...
	//This function will be called when user click product tool
	function scProductToolOpen(obj){
		var s = s_gi(s_account);
		s.linkTrackVars='events,eVar13';
		s.linkTrackEvents='event14';
		s.events='event14';
		s.tl(obj,'o','product tool');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.eVar13='';
	...
	//This function will be called when user send product to friend
	function scProductSendToFriend(obj){
		var s = s_gi(s_account);
		s.linkTrackVars='events';
		s.linkTrackEvents='event28';
		s.events='event28';
		s.tl(obj,'o','send to friend');
		s.linkTrackVars='None';
		s.linkTrackevents='None';
		s.events='';
		s.pageName='';
	...
	//This function will be called when user open product tool
	function scFindInStore(obj,pageName){
		var s = s_gi(s_account);
		...
		s.events='event27';
		if(pageName=="PDP"){
			s.eVar45="PDP:"+prodId+":"+prodName;
		}
		if(pageName=="cart"){
			s.eVar45="Cart:"+prodId+":"+prodName;
		}
		if(pageName=="wishList"){
			s.eVar45="WishList:"+prodId+":"+prodName;
		}
	...
	function s_doPlugins(s) {
		...
		/* Channel Manager */
		  ...
		  if (typeof o != 'undefined' && o){
		    ...
		    }else if(o.channel == 'Paid Search'){
		    }else if(o.channel =='Email'){
		    }else if(o.channel =='Banner'){
		    }else if(o.channel =='Print'){
		    }else if(o.channel =='Affiliate'){
		    }else if(o.channel =='Social Network'){
		    }else if(o.channel =='Data Feed'){
		    ...
		    if(scCampDedupe){
		      ...
		      s.eVar21=o.keyword;
		      s.eVar22=o.partner;
		      s.eVar9 = s.crossVisitParticipation(s.campaign,'s_cpm_cvp','30','5','>','purchase');
		      s.eVar20 = s.crossVisitParticipation(s.eVar19,'s_evar20_cvp','30','5','>','purchase');
		      s.eVar27 = s.crossVisitParticipation(s.eVar21,'s_evar27_cvp','30','5','>','purchase');
		      var scDate = new Date();
		      var scM = scDate.getMonth() + 1;
		      var scD = scDate.getDate();
		      var scY = scDate.getFullYear();
		      var scDateStamp = scM + "/" + scD + "/" + scY;
		      var scStackCodeDate = s.campaign + " " + scDateStamp;
		      var scStackChanDate = s.eVar19 + " " + scDateStamp;
		      s.eVar25 = s.crossVisitParticipation(scStackChanDate,'s_evar25_cvp','30','5','>','purchase');
		      s.eVar26 = s.crossVisitParticipation(scStackCodeDate,'s_evar26_cvp','30','5','>','purchase');
			...
			/* clickThruQuality */
		  s.clickThruQuality(s.campaign,'event16','event17');
			...
			if(s.prop10){
				...
				s.eVar10=s.prop10;
				var t_search=s.getValOnce(s.eVar10,'s_evar10',0);
				if(t_search){
					s.events=s.apl(s.events,"event2",",",2);
				}
			}

			/* Start -- Adding code to change pageName,channel,prop1,prop2,prop3,prop4,eVar12 */
			if(s.pageName){
			...
			if(s.eVar12){
				s.eVar12=s.eVar12.toLowerCase();
			}
			if(s.purchaseID){
				s.eVar28 = s.purchaseID;
			}
			/* End -- Adding code to change pageName,channel,prop1,prop2,prop3,prop4,eVar12 */

			/*   Get New-Repeat Status  */
		  s.prop7=s.eVar7=s.getNewRepeat(365);

			/* Copy props to eVars*/
			if(s.prop11&&!s.eVar11) s.eVar11=s.prop11;

			/* Advanced pathing */
		  if(s.prop11 && s.pageName && !s.prop12) s.prop12=s.prop11 + ":" + s.pageName;

		/* Genesis Integration */

		/* Campaign or Message ID Tracking */
			if(!s.eVar23){
				s.eVar23=s.getQueryParam('om_mid');
			}
			s.eVar23=s.getValOnce(s.eVar23,'s_evar23',0);

		/* Recipient or Visitor ID Tracking */
			if(!s.eVar24){
				s.eVar24=s.getQueryParam('om_rid');
			}
		}
 ...
 * ChannelManager - v1.1
 */
s.___se="{'Paid Search':{p:['cmp=ppc|'Sina - China':{^q=|~g`.cn/$?cli"
...
+"t Bing':{^q=|~bing*>},'Email':{p:['cmp=emc>,'Banner':{p:['cmp=bac>,"
+"'Print':{p:['cmp=pac>,'Affiliate':{p:['cmp=afl>,'Social Network':{p"
+":['cmp=snc>,'Data Feed':{p:['cmp=dfc>}";
s.__se = new Function(""
+"var l={'~':'tl:[\\'','^': 'kw:[\\'','%': 'ahoo','|': '\\'],','>': '"

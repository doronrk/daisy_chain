...
{this.eo.onComplete=RightNow.Client.Event.evt_conditionalChatLinkAvailabilityResponse;this.eo.callback=callback;this.eo.scope=scope;RightNow.Client.Event.evt_dataRequest.fire(this.eo);};};var liveChatWidget_0=new RightNow.Client.ConditionalChatLink();liveChatWidget_0.instance_id="liveChatWidget_0";liveChatWidget_0.uri="//customercare.toryburch.com/";liveChatWidget_0.ds="ci/ds/get";liveChatWidget_0.CT=new RightNow.Client.CT("//customercare.toryburch.com/ci/dqa/publish");liveChatWidget_0.name="ConditionalChatLink";liveChatWidget_0.data={"base_url":"http:\/\/customercare.toryburch.com","request_source":8,"p":null,"c":null,"label_minute":"Minute","label_minutes":"Minutes","label_second":"Second","label_seconds":"Seconds","cached_content_server":"\/\/toryburch.widget.custhelp.com","uri":"\/\/toryburch.widget.custhelp.com\/ci\/ajaxRequestOptional\/checkChatQueue\/avail_type\/sessions\/cacheable\/true"};liveChatWidget_0.attrs={"enable_availability_check":true,"enable_polling":true,"ignore_preroute":false,"wait_threshold":40,"min_sessions_avail":0,"p":"","c":"","custom_fields":"","chat_login_page":"\/app\/chat\/chat_launch_blank\/Incident.CustomFields.c.source_url\/http%3A%2F%2Fwww.toryburch.com%2Fashley-dress%2F41141452.html%3Fstart%3D1%26dwvar_41141452_color%3D001\/Incident.CustomFields.c.page_name\/Product%20Detail\/Incident.CustomFields.c.additional_details\/Style%2041141452%2C%20ASHLEY%20DRESS","chat_login_page_width":350,"chat_login_page_height":550,"open_in_new_window":true,"label_available_with_wait_template":"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Questions?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ask a specialist.","label_available_immediately_template":"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Questions?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ask a specialist.","label_unavailable_busy_template":"All agents are busy.","label_unavailable_hours":"We're sorry, chat is currently unavailable.","label_default":"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Questions?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ask a specialist.","container_element_id":"chatLinkContainer","link_element_id":"chatLink","info_element_id":"chatLinkInfo","instance_id":"liveChatWidget_0","module":"ConditionalChatLink","type":7,"instance":"conditionalchatlink"};liveChatWidget_0.view="<a id=\"rn_liveChatWidget_0_Link\" href=\"javascript:void(0);\" onclick=\"liveChatWidget_0.chatLinkClicked();\"><\/a>\n";RightNow.Client.Controller.verifyDiv(liveChatWidget_0.attrs.div_id);liveChatWidget_0.init();if(document.readyState==="complete"){liveChatWidget_0.render(liveChatWidget_0);}else{RightNow.util.Event.onDOMReady(liveChatWidget_0.render,liveChatWidget_0,true);}
var _rnq=_rnq||[];_rnq.push({"uh":"d5e9dd1a","uc":"toryburch.widget.custhelp.com\/ci\/widgetService\/get","b":"ca94031","i":"toryburch:toryburch","f":"rnw","p":"CP Syndicated Widget","v":"14.5.0.1-b119-sp3","th":"www.rnengage.com"});
...
d),a.src=f.pop(),this.body.appendChild(a)};b.write('<body onload="document._l();">');b.close()})(["https://www.rnengage.com/api/e/ca94031/e.js","//www.rnengage.com/api/1/javascript/acs.js"]);

...
Element.addMethods({
	...
	*/
	...
	replaceClassName: function(element, r, a){
		element.removeClassName(r).addClassName(a)
	},
...
Df.XMLDocument = Class.create({
	...
	getNodeValue: function(exp){
		var node = this.xpath(exp)
...
Df.XMLNode = {
    ...
    getValue: function(){
	return $XML(this).childNodes[0].nodeValue;
    }
}

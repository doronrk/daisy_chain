...
}}if(isShowPromotionInfoInIss()&&crtSel===0&&!redirect){crtSel=crtSel-1;
redirect=true;
...
return html;
}function isShowPromotionInfoInIss(){if(typeof opt!=="undefined"&&opt.hasOwnProperty("isShowPromotionInfoInIss")&&opt.isShowPromotionInfoInIss===1){var targetKeywordsAarry=new Array(["\u53cc\u5341\u4e00"],["\u53cc11"],["shuangshiyi"],["shuang11"],["\u5149\u68cd\u8282"],["guanggunjie"]);
for(i=0;
i<targetKeywordsAarry.length;
i++){if(keyword().indexOf(targetKeywordsAarry[i])>-1){return true;
}}}return false;
...
}if(isShowPromotionInfoInIss()){dropdownHtml+='<div id="promotion" class="suggest_link">'+'<span style="color:#e47911; font-weight:bold;">2014\u4e9a\u9a6c\u900a\u53cc\u5341\u4e00\u4fc3\u9500 </span>'+'<span style="color:#888888;"> \u70b9\u51fb\u8fdb\u5165 </span>'+"</div>";
...
}if($("#promotion")!==null&&$("#promotion").length>0){$("#promotion").mouseover(suggestOver).mouseout(suggestOut).click(leadToPromotionPage);
...
}}function leadToPromotionPage(){document.location.href="/b/ref=nb_sb_ss_p?ie=UTF8&node=361165071";
...
}function highlightCurrentSuggestion(updateSearchBox){if(!(crtSel>-1)&&isShowPromotionInfoInIss()){if(suggType=="sugg"){isPromotionSelected=true;
updateSearchBox&&keyword("2014\u4e9a\u9a6c\u900a\u53cc\u5341\u4e00\u4fc3\u9500");
}highlightSuggestion($("#promotion"));
}else{if(suggType=="sugg"){updateSearchBox&&updateCrtSuggestion();
}highlightSuggestion($("#"+opt.sugPrefix+crtSel));
}}function unhighlightCurrentSuggestion(){if(!(crtSel>-1)&&isShowPromotionInfoInIss()){isPromotionSelected=false;
unhighlightSuggestion($("#promotion"));
}else{unhighlightSuggestion($("#"+opt.sugPrefix+crtSel));
...
},isShowPromotionInfoInIssEnabled:function(){return opt.isShowPromotionInfoInIss===1;
},isPromotionSelected:function(){return isPromotionSelected;

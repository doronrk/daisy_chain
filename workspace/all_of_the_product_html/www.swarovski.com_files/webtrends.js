...
// Created: 5/23/2012 11:19:13 AM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	// @author bauech: removed dcsid (profile id), will be set when webtrends is initialized
	this.dcsid="";
	this.domain="sdc.swarovski.com";
	this.timezone=1;
	this.onsitedoms="";
	this.downloadtypes="xls,doc,docx,xlsx,ppt,pptx,pdf,txt,csv,zip,rar,sit";

...
//PLUGINS_LIST=globalUtilsV2,simpleDeploy
...
lpMTagConfig.plugins['simpleDeploy'] = {
		...
		config : {
			...
			buttons : [{"name":"chat-sales-had-english","pid":"lpChatButton","afterStartPage":true,'ovr':'lpMTagConfig.db1'},
			           {"name":"chat-sales-had-english-2","pid":"lpChatButton2","afterStartPage":true,'ovr':'lpMTagConfig.db1'},
			           {"name":"chat-sales-had-login-english","pid":"lpChatLoginButton","afterStartPage":true,'ovr':'lpMTagConfig.db1'},
			           {"name":"chat-sales-had-header-english","pid":"lpChatHeaderButton","afterStartPage":true,'ovr':'lpMTagConfig.db1'},
			           {"name":"chat-sales-had-b2b-english","pid":"lpChatB2BButton","afterStartPage":true,'ovr':'lpMTagConfig.db1'}]

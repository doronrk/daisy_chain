...
FSR.properties = {
    ...
    cpps: {
        isLoggedIn: {
            source: 'function',
            value: function(){
                if (BC.user.isLoggedIn) {
                    if (BC.user.isLoggedIn = true) {
                        return 'true'
                    }
                }
                return 'false';
        ...
        isRecognized: {
            source: 'function',
            value: function(){
                if (BC.user.isRecognized) {
                    if (BC.user.isRecognized = true) {
                        return 'true'
                    }
                }
                return 'false';
        ...
        isRegistered: {
            source: 'function',
            value: function(){
                if (BC.user.isRegistered) {
                    if (BC.user.isRegistered = true) {
                        return 'true'
                    }
                }
                return 'false';

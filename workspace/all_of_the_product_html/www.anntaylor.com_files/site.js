...
$(function() {
   ...
   $("#ShareThis a.js-close").click(function(){
    ...
    $(".js-genericLargePopup").click(function(evt) {
		var $this = $(this),
			returnFocus = document.activeElement,
		...
		lib.layer.create("#genericLayerLargeContent", {
			...
			keepCentered : false,
			callback : function() {
				$("#genericLayerLargeContent").bind("mousedown", function(e){ beginPopupDrag(this, e) });
				$("#genericLayerLargeContent iframe").attr("src", iframeSRC);
				$("#genericLayerLargeContent").animate({"width": popupWidth}, 0);
				$("#genericLayerLargeContent iframe").animate({"height": iframeHeight}, 0);
    ...
    lib.input.defaultText("#FooterSingleSignup", {defaultText: "SIGN UP FOR EMAIL UPDATES"}) ;

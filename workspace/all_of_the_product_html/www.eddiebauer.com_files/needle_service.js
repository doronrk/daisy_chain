...
N.nps='2';else
N.nps='3';}
N.analyticsCall=function(a,v,e){function cmRequest(type){if(typeof cmCreateElementTag=='function'&&typeof coremetrics!='undefined'&&coremetrics.cmLastReferencedPageID){cmCreateElementTag(coremetrics.cmLastReferencedPageID+':Needle:'+v+':'+type,'Needle');}};var type='';if(a==='bc'){type='Invite Click';}else if(a==='qc'){type='Qualified Chat';}else if(a==='bi'){type='Invite Impression';}else{N.PageUpdate('A',"&call="+a+"&error=3");return;}

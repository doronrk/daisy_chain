...
{
	document.write('<IMG class="dpointer" id=dhtmlpointer style="DISPLAY: none; WIDTH: 55px; HEIGHT: 101px" src="images/up-left-combo.png">')
	document.write('<IMG class="dpointer" id=dhtmlpointer1 style="DISPLAY: none; WIDTH: 55px; HEIGHT: 101px" src="images/lower-left-combo.png">')
	document.write('<IMG class="dpointer" id=dhtmlpointer2 style="DISPLAY: none; WIDTH: 55px; HEIGHT: 101px" src="images/up-right-combo.png">')
	document.write('<IMG class="dpointer" id=dhtmlpointer3 style="DISPLAY: none; WIDTH: 55px; HEIGHT: 101px" src="images/lower-right-combo.png">')	
	document.write('<DIV id="dhtmltooltip">')
	document.write('<DIV><IMG id="topbox" style="WIDTH: 285px; HEIGHT: 21px" src="images/topcap.png"></DIV>')
	document.write('<DIV id="titlebox" style="background-image:url(\'images/titlemiddle.png\'); width:285px;"><div id="tcontent" style="position:relative; padding:5px 0px 7px 20px; width: 245px; text-align: left;"></div></DIV>')
	document.write('<DIV id="boxcontent" style="background-image:url(\'images/contentmiddle.png\'); width:285px; POSITION: relative"><div id="mcontent" style="position:relative; padding:5px 0px 7px 20px; width: 245px; text-align: justify;"></div></DIV>')
	document.write('<DIV><IMG id="bottombox" style="WIDTH: 285px; HEIGHT: 25px" src="images/bottomcap.png"></DIV>')
	document.write('</DIV>')
}
...
function hidetip()
{
	if (ns6||ie)
	{
		...
		pointerobj.left="-300"
		pointerobj.top="-100"
		pointerobj1.left="-300"
		pointerobj1.top="-100"
		pointerobj2.left="-300"
		pointerobj2.top="-100"
		pointerobj3.left="-300"
		pointerobj3.top="-100"

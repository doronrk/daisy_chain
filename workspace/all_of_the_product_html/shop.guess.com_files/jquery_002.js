	...
	this.each(function () {
		...
		if (options == "hide") {
			...
			switch (position) {
				...
				case "right":
					if (position == "left") {
						left = tleft - width - $tri.outerWidth() + 10; //25: triangle width + margin
						$tri.css("left", width); //10: triangle width, 1: adjust border

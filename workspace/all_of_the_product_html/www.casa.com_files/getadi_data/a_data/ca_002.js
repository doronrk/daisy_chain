...
if(!c){return}var a=truste.ca2.findDivWrapper(c,k);if(!a){a=truste.ca2.getNextSibling(c,k)}if(!a){return null
...
break}}if(e){a=e}}}return a};truste.ca2.findDivWrapper=function(e,c){var d=truste.ca2.getPreviousSibling(e,c);
if(d){var f=truste.ca2.findSizeMatch(d,c.width,c.height);if(truste.ca2.IEVersion()&&!f&&(d.offsetWidth!=c.width||d.offsetHeight!=c.height)){var a=truste.ca2.getNextSibling(d,c);
if(a){f=a}}if(f){d=f}}return d};truste.ca2.showInterstitial=function(a){truste.ca2.showoverlay(a);return false
...
var d=document.getElementById(a.iconSpanId);if(d&&d.parentNode){d.parentNode.removeChild(d)}var e=(window.location.protocol=="http:")?"http://choices.truste.com/get?name=":"https://choices.truste.com/get?name=";

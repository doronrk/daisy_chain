/*
 ...
 MyFonts Webfont Build ID 2827750, 2014-06-12T09:43:06-0400
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2827750

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2b25e6";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=1;
...
for(var fonts=[{fontFamily:"DidotLTPro-Roman",url:wfpath+"2B25E6_0"+suffix+"_0."+webfontType},{fontFamily:"DidotLTPro-Bold",url:wfpath+"2B25E6_1"+suffix+"_0."+webfontType},{fontFamily:"DidotLTPro-Italic",url:wfpath+"2B25E6_2"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+

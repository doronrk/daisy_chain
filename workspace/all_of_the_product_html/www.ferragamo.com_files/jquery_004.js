 ...
 */(function(e) {
        ...
        r.flexAnimate = function(t, n, s, u, a) {
            ...
            if (!r.animating && (r.canAdvance(t, a) || s) && r.is(":visible")) {
                ...
                if (!p) {
                    ...
                    /** start custom */
                    $jq("#last_bc_item").html($jq(".flex-active-slide .flex-caption").html());
                    /** end custom   */
                    ...
                    /** start custom */
                    $jq("#last_bc_item").html($jq(".flex-active-slide .flex-caption").html());
					if ($jq(".flex-active-slide").children("img").attr("src") == "") {
						$jq(".flex-active-slide").children("img").attr("src",  $jq(".flex-active-slide").children("img").attr("rel")); 
					}
					/** end custom   */
    ...
    //ALERT ----- caugelli
    //Modificata la var globale slideshow per disabilitare la gallery. 
    //E' stato necessaria la modifica in questo punto in quanto in qualsiasi altro punto non sortisce nessun effetto

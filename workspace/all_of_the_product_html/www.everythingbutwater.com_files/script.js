...
/* Build Date 12/2/2014 5:01:32 AM */
...
identifiers.SessionID=_ltk.GetCookie("STSID766482");assembler=new _Assembler();assembler.QueryMode=1;assembler.EndPointArray=new Array();assembler.EndPointArray.push('at1.listrakbi.com');assembler.EndPointPath='/Handlers/Set.ashx';assembler.QueryHeader='ctid=SadvKLqKgI5T&uid='+_ltk.uuidCompact()+'&gsid='+_ltk.Session.GlobalID;assembler.AddObject(identifiers);assembler.AddArrayObject(activityArray);assembler.Flush();activityArray.length=0;}
...
_Alerts.prototype.Load=function(){this.MerchantTrackingID='SadvKLqKgI5T';}
...
{
    var _ltk = new LTK();
    _ltk.Client.CTID = "SadvKLqKgI5T";
    
    _ltk.SCA.Load("766482");

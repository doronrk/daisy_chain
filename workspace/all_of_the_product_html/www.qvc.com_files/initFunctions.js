...
function initFunctions(){
	...
	*/
	...
	var allTags = jQuery(".stripeTable");
	...
	jQuery('#divProductDetailViewThumbnailsImages a img').each(function(){
		jQuery(this).css("border", "2px solid #e4e2e3");
	...
	if(imgFound == false && jQuery('#divProductDetailViewThumbnailsImages a img')[0]){
                  setSelected(jQuery('#divProductDetailViewThumbnailsImages a img')[0]);
             }

...
function program1(depth0,data) {
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n            </div>\n            <div class=\"divider\"/>\n            <div class=\"shop\">\n                ";
  stack2 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.productThumbnail)),stack1 == null || stack1 === false ? stack1 : stack1.defaultCategoryId), {hash:{},inverse:self.noop,fn:self.program(2, program2, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n            </div>\n\n        </div>\n       ";
...
function program2(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n                    ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.categoryName), {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
...
function program3(depth0,data) {
  ...
  buffer += "\n                        <a href=\"/shop/?id="
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.productThumbnail)),stack1 == null || stack1 === false ? stack1 : stack1.defaultCategoryId)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">shop ";
  if (stack2 = helpers.categoryName) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = (depth0 && depth0.categoryName); stack2 = typeof stack2 === functionType ? stack2.call(depth0, {hash:{},data:data}) : stack2; }
  buffer += escapeExpression(stack2)
    + "</a>\n                    ";
  return buffer;
  }
...
function program5(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\">\n    ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.loaded), {hash:{},inverse:self.program(5, program5, data),fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</li>\n";
  return buffer;
  })

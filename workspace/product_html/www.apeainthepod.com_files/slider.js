...
ddaccordion.init({
	...
	togglehtml: ["src", "http://i13.tinypic.com/80mxwlz.gif", "http://i18.tinypic.com/6tpc4td.gif"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
...
ddaccordion.init({
	...
	//revealtype: "click", // commented out top section of revealtype to not show up subslider
	mouseoverdelay: 200, 
	collapseprev: false, 
	defaultexpanded: [], 
	onemustopen: false, 
	...
	togglehtml: ["prefix", "<img src='http://i13.tinypic.com/80mxwlz.gif' /> ", "<img src='http://i18.tinypic.com/6tpc4td.gif' /> "], 
	animatespeed: "fast", 
...
ddaccordion.init({
	...
	persiststate: false, 
	toggleclass: ["", ""], 
	togglehtml: ["suffix", "", "<span class=sliderclose>&nbsp; &nbsp;(remove)</span>"], 
	animatespeed: "fast", 
	oninit:function(expandedindices){ 
	},
	onopenclose:function(header, index, state, isuseractivated){ 

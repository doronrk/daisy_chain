//tealium universal tag - utag.1052 ut4.0.201410271903, Copyright 2014 Tealium.com Inc. All Rights Reserved.
var s_account="demandninewestprod";var s=s_gi(s_account);s.dynamicAccountSelection=true;s.dynamicAccountList="demandninewestdev=int.ninewest.com,staging2.ninewest.com";s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters="Javascript;";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="USD";s.visitorNamespace="demandware";s.trackingServer="vitals.ninewest.com";s.trackingServerSecure="svitals.ninewest.com";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.26';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(s.rep(m,\"\\\\\",\"\\\\\\"
...
utag.DB("send:1052:COMPLETE");}}
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('1052','thejonesgroup.ninewest');}catch(e){};
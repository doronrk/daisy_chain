FSR.surveydefs = [{
    ...
    invite: {
        ...
        dialogs: [[{
            ...
            blurb: "Can we email or text you a brief customer satisfaction survey so we can improve your mobile experience?",
...
FSR.properties = {
    ...
    exclude: {
        variables: [{
            name: 'fsr$ip',
            value: ['167.64.57.21', '10.36.72.*', '10.36.73.*', '10.36.74.*', '10.36.75.*']
        }]
    },
    ...
    invite: {
        ...
        exclude: {
            urls: ['/OrderItemDisplay', '/VFShippingAddressView', '/VFBillingAndPaymentView', '/SingleShipmentOrderSummaryView', '/OrderOKView'],
            referrers: [],
            userAgents: [],
            browsers: [],
            cookies: [],
    ...
    events: {
        ...
        custom: {
            ...
            items: {
                ...
                repeat: false,
                source: 'variable',
                name: 'sh_shopCartQuantity'
            },
            dollars: {
                enabled: true,
                repeat: false,
                source: 'variable',
                name: 'sh_shopCartValue'
            }
        }
    },

...
function modi_price(_price, _taxes, _orig_price) {
    ...
    if ( _price == 0 ) {
        _price = product_price_no_options;
    }
	...
	for (var x2 in modifiers) {
        ...
        // We stop adding the service plan so we can do it ourselves after checking the tier later
        if ( elm[3].indexOf('Care Plan') >= 0 ) {
            break;
        }
    ...
    // Fresh Custom Code
    if ( typeof( $('[class*="care-plan-dropdown"]')[0] ) != 'undefined' ) {

        update_tier(return_price);
        ...
        if ( $('.care-plan-checkbox')[0].checked ) {
         
            return_price += tier_price;

        } else {

            $('[class*="care-plan-dropdown"]')[0].selectedIndex = 0;

        }

    }

    if ( typeof( tier_price ) != 'undefined' ) {
        var formatted_price = '(+$'+tier_price+')';
        $('.care-plan-price-box').html(formatted_price);
    }
    //End Fresh Custom Code
...
function update_tier(price){

    var tier = 0;

    if ( category.indexOf('Watch') >= 0 ) {
        if (price <= 99.99) {
            tier = '1';
        }
        else if (100 <= price && price < 249.99) {
            tier = '2';
        }
        else if (250 <= price && price < 499.99) {
            tier = '3';
        }
        else if (500 <= price && price < 999.99) {
            tier = '4';
        }
        else if (1000 <= price && price < 1999.99) {
            tier = '5';
        }
        else if (2000 <= price && price < 2999.99) {
            tier = '6';
        }
        else if (3000 <= price && price < 4999.99) {
            tier = '7';
        }
        else if (5000 <= price && price < 5999.99) {
            tier = '8';
        }
        else if (6000 <= price && price < 7999.99) {
            tier = '9';
        }
        else if (8000 <= price && price < 9999.99) {
            tier = '10';
        }
        else if (10000 <= price && price < 14999.99) {
            tier = '11';
        }
        else if (15000 <= price && price < 19999.99) {
            tier = '12';
        }
        else if (20000 <= price && price < 29999.99) {
            tier = '13';
        }
    } else {
        if (price <= 99.99) {
        ...
        else if (100 <= price && price < 199.99) {
            tier = '2';
        }
        else if (200 <= price && price < 299.99) {
            tier = '3';
        }
        else if (300 <= price && price < 499.99) {
            tier = '4';
        }
        else if (500 <= price && price < 799.99) {
            tier = '5';
        }
        else if (800 <= price && price < 999.99) {
            tier = '6';
        }
        else if (1000 <= price && price < 1499.99) {
            tier = '7';
        }
        else if (1500 <= price && price < 1999.99) {
            tier = '8';
        }
        else if (2000 <= price && price < 2999.99) {
            tier = '9';
        ...
        else if (5000 <= price && price < 7499.99) {
            tier = '11';
        }
        else if (7500 <= price && price < 9999.99) {
            tier = '12';
        }
        else if (10000 <= price && price < 14999.99) {
            tier = '13';
    ...
    if ( typeof( $('[class*="care-plan-dropdown"]')[0] ) != 'undefined' ) {
        $('[class*="care-plan-dropdown"]')[0].selectedIndex = tier;

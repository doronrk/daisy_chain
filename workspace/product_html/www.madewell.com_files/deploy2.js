...
//PLUGINS_LIST=simpleDeploy,GlobalUtilsV2
...
lpMTagConfig.plugins["simpleDeploy"] = {
	...
	config:{
		...
		buttons:[
		{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-general",
			"pid":"lpMCButton",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-top",
			"pid":"lpMCButtonMadewell",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-product",
			"pid":"lpMCButtonProduct",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-mens",
			"pid":"lpMCButtonMen",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-womens",
			"pid":"lpMCButtonWomen",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-crewcuts",
			"pid":"lpMCButtonCrew",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-wedding",
			"pid":"lpMCButtonWed",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-checkout",
			"pid":"lpMCButtonCheck",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-help",
			"pid":"lpMCButtonHelp",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-sale",
			"pid":"lpMCButtonSale",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-letstalk",
			"pid":"lpMCButtonLetsTalk",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-footer",
			"pid":"lpMCButtonFooter",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		},{
			"name":"mc-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-cart",
			"pid":"lpButtonCart",
			"afterStartPage":true,
			"ovr":"lpMTagConfig.db1"
		}

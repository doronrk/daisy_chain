...
{this.eo.onComplete=RightNow.Client.Event.evt_conditionalChatLinkAvailabilityResponse;this.eo.callback=callback;this.eo.scope=scope;RightNow.Client.Event.evt_dataRequest.fire(this.eo);};};var sccl_2122799=new RightNow.Client.ConditionalChatLink();sccl_2122799.instance_id="sccl_2122799";sccl_2122799.uri="https://destinationxl.custhelp.com/";sccl_2122799.ds="ci/ds/get";sccl_2122799.CT=new RightNow.Client.CT("https://destinationxl.custhelp.com/ci/dqa/publish");sccl_2122799.name="ConditionalChatLink";sccl_2122799.data={"base_url":"https:\/\/destinationxl.custhelp.com","request_source":8,"p":null,"c":null,"label_minute":"Minute","label_minutes":"Minutes","label_second":"Second","label_seconds":"Seconds","cached_content_server":"https:\/\/destinationxl.widget.custhelp.com","uri":"https:\/\/destinationxl.widget.custhelp.com\/ci\/ajaxRequestOptional\/checkChatQueue\/avail_type\/sessions\/cacheable\/true"};sccl_2122799.attrs={"enable_availability_check":false,"enable_polling":false,"ignore_preroute":true,"wait_threshold":40,"min_sessions_avail":0,"p":"","c":"","custom_fields":"{}","chat_login_page":"\/app\/chat\/chat_launch","chat_login_page_width":700,"chat_login_page_height":686,"open_in_new_window":true,"label_available_with_wait_template":"An agent should be available in {TIME} ({NUM_MINUTES} {MINUTES} and {NUM_SECONDS} {SECONDS}).","label_available_immediately_template":"Agents are available with no wait time.","label_unavailable_busy_template":"All agents are busy.","label_unavailable_hours":"We're sorry, chat is currently unavailable.","label_default":"Need Live Help?","container_element_id":"myChatLinkContainer","link_element_id":"myChatLink","info_element_id":"myChatLinkInfo","common_fields":"{}","ee_id":"200106306459","estara_id":"1000HRq3relAz6dN3VuDgNdW5rQbUEnRkNPtvbz2rpYA4uAE31","instance_id":"sccl_2122799","module":"ConditionalChatLink","ruleid":"2122801","ts":1417586319891,"type":7,"visitor_id":"1000HRq3relAz6dN3VuDgNdW5rQbUEnRkNPtvbz2rpYA4uAE318","vstype":4,"widget_id":"2122799","widget_name":"sccl_0","instance":"conditionalchatlink"};sccl_2122799.view="<a id=\"rn_sccl_2122799_Link\" href=\"javascript:void(0);\" onclick=\"sccl_2122799.chatLinkClicked();\"><\/a>\n";RightNow.Client.Controller.verifyDiv(sccl_2122799.attrs.div_id);sccl_2122799.init();if(document.readyState==="complete"){sccl_2122799.render(sccl_2122799);}else{RightNow.util.Event.onDOMReady(sccl_2122799.render,sccl_2122799,true);}
var _rnq=_rnq||[];_rnq.push({"uh":"85175b84","uc":"destinationxl.widget.custhelp.com\/ci\/widgetService\/get","b":"ca35590","i":"casualmale:destinationxl","f":"rnw","p":"CP Syndicated Widget","v":"14.2.0.1-b131-sp4","th":"www.rnengage.com"});
...
d),a.src=f.pop(),this.body.appendChild(a)};b.write('<body onload="document._l();">');b.close()})(["https://www.rnengage.com/api/e/ca35590/e.js","//www.rnengage.com/api/1/javascript/acs.js"]);

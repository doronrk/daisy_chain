...
function addPopup(popupName, closeLocation, redirect){
	...
	if (useNonMacMSPops) {
		...
		document.write('			<img class="popTtl" id="' + popupName + 'TitleImage" onMouseMove="return false;" onMouseDown="return false;" src="/assets/images/header/nv_logo_sm.gif" alt="LOFT"/>');

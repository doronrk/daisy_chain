...
new SC_StubQP('Aeropostale14006018885379_s_aero');
...
var s_account="aeropostale-aeropostale"
var s_aero=s_gi(s_account)
s_aero.debugTracking=false
s_aero.charSet = "UTF-8"

/* Link and ClickMap tracking */
s_aero.trackDownloadLinks=true
s_aero.trackExternalLinks=true
s_aero.trackInlineStats=true
s_aero.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
s_aero.linkInternalFilters="javascript:,."
s_aero.linkLeaveQueryString=false
s_aero.linkTrackVars="None"
s_aero.linkTrackEvents="None"

s_aero.usePlugins=true
function s_aero_doPlugins(s) {
/* Add usage of plugins here */

 s.campaign = s.getQueryParam('adbsc');

if (s.campaign || +s.c_r('pop_event1' )) { s.events=s.apl(s.events,"event1",",",2);
s.c_w('pop_event1', 1); }
...
s_aero.doPlugins=s_aero_doPlugins
 ...
 */
s_aero.repl=new Function("x","o","n",""
 ...
 */
s_aero.apl=new Function("L","v","d","u",""
 ...
 */
s_aero.getQueryParam=new Function("p","d","u",""
+"var s=this,v='',i,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.locati"
+"on);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p"
+".length:i;t=s.p_gpv(p.substring(0,i),u+'');if(t){t=t.indexOf('#')>-"
+"1?t.substring(0,t.indexOf('#')):t;}if(t)v+=v?d+t:t;p=p.substring(i="
+"=p.length?i:i+1)}return v");
s_aero.p_gpv=new Function("k","u",""
+"var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=s.pt(q,'&','p_gvf',k)}return v");
s_aero.p_gvf=new Function("t","k",""
 ...
 */
s_aero.socialPlatforms=new Function("a",""
...
s_aero.socPlatList="facebook.com>Facebook|twitter.com>Twitter|t.co/>Twitter|youtube.com>Youtube|clipmarks.com>Clipmarks|dailymotion.com>Dailymotion|delicious.com>Delicious|digg.com>Digg|diigo.com>Diigo|flickr.com>Flickr|flixster.com>Flixster|fotolog.com>Fotolog|friendfeed.com>FriendFeed|google.com/buzz>Google Buzz|buzz.googleapis.com>Google Buzz|plus.google.com>Google+|hulu.com>Hulu|identi.ca>identi.ca|ilike.com>iLike|intensedebate.com>IntenseDebate|myspace.com>MySpace|newsgator.com>Newsgator|photobucket.com>Photobucket|plurk.com>Plurk|slideshare.net>SlideShare|smugmug.com>SmugMug|stumbleupon.com>StumbleUpon|tumblr.com>Tumblr|vimeo.com>Vimeo|wordpress.com>WordPress|xanga.com>Xanga|metacafe.com>Metacafe|pinterest.com>Pinterest";

/*  
  * socialAuthors v1.5.1
 */
s_aero.socialAuthors=new Function("",""
...
+"ialauthor']=s.user;}}");
s_aero.socialAuthorSearch=new Function("obj",""
...
s_aero.maxDelay='3000'; //max time to wait for 3rd party api response in milliseconds
s_aero.loadModule("Integrate")
s_aero.Integrate.onLoad=function(s_aero,m){
s_aero.socialAuthors();
...
s_aero.visitorNamespace = "aeropostale"
s_aero.trackingServer = "aeropostale.d2.sc.omtrdc.net";
s_aero.trackingServerSecure = "";


/****************************** MODULES *****************************/
/* Module: Integrate */
s_aero.m_Integrate_c="var m=s.m_i('Integrate');m.add=function(n,o){var m=this,p;if(!o)o='s_Integrate_'+n;if(!m.s.wd[o])m.s.wd[o]=new Object;m[n]=new Object;p=m[n];p._n=n;p._m=m;p._c=0;p._d=0;p.disable=0;p"
...
s_aero.m_i("Integrate");



s_aero.setTagContainer("Aeropostale14006018885379_s_aero");

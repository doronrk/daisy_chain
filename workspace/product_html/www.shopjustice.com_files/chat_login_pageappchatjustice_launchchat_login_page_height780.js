...
{this.eo.onComplete=RightNow.Client.Event.evt_conditionalChatLinkAvailabilityResponse;this.eo.callback=callback;this.eo.scope=scope;RightNow.Client.Event.evt_dataRequest.fire(this.eo);};};var justice_2=new RightNow.Client.ConditionalChatLink();justice_2.instance_id="justice_2";justice_2.uri="https://speedcommerce.custhelp.com/";justice_2.ds="ci/ds/get";justice_2.CT=new RightNow.Client.CT("https://speedcommerce.custhelp.com/ci/dqa/publish");justice_2.name="ConditionalChatLink";justice_2.data={"base_url":"https:\/\/speedcommerce.custhelp.com","request_source":8,"p":"6","c":null,"label_minute":"Minute","label_minutes":"Minutes","label_second":"Second","label_seconds":"Seconds","cached_content_server":"https:\/\/speedcommerce.widget.custhelp.com","uri":"https:\/\/speedcommerce.widget.custhelp.com\/ci\/ajaxRequestOptional\/checkChatQueue\/avail_type\/sessions\/cacheable\/true\/prod\/6"};justice_2.attrs={"enable_availability_check":true,"enable_polling":true,"ignore_preroute":false,"wait_threshold":40,"min_sessions_avail":0,"p":"6","c":"","custom_fields":"","chat_login_page":"\/app\/chat\/justice_launch","chat_login_page_width":510,"chat_login_page_height":780,"open_in_new_window":true,"label_available_with_wait_template":"online","label_available_immediately_template":"online","label_unavailable_busy_template":"offline","label_unavailable_hours":"offline","label_default":"online","container_element_id":"myChatLinkContainer3","link_element_id":"myChatLink3","info_element_id":"myChatLinkInfo3","instance_id":"justice_2","module":"ConditionalChatLink","type":7,"instance":"conditionalchatlink"};justice_2.view="<a id=\"rn_justice_2_Link\" href=\"javascript:void(0);\" onclick=\"justice_2.chatLinkClicked();\"><\/a>\n";RightNow.Client.Controller.verifyDiv(justice_2.attrs.div_id);justice_2.init();if(document.readyState==="complete"){justice_2.render(justice_2);}else{RightNow.util.Event.onDOMReady(justice_2.render,justice_2,true);}
var _rnq=_rnq||[];_rnq.push({"uh":"e962574d","uc":"speedcommerce.widget.custhelp.com\/ci\/widgetService\/get","b":"ca97370","i":"speedcommerce:speedcommerce","f":"rnw","p":"CP Syndicated Widget","v":"14.8.0.1-b113-sp1","th":"www.rnengage.com"});

//tealium universal tag - utag.7 ut4.0.201405080041, Copyright 2014 Tealium.com Inc. All Rights Reserved.
var _gaq=_gaq||[];try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1};u.max_custom=10;u.clearVar=function(){for(var i=1;i<=u.max_custom;i++){_gaq.push([u.prefix+'_deleteCustomVar',i])}};u.domain="torrid.com"||utag.loader.lh();u.prefix="";u.prefix=((u.prefix)?u.prefix+'.':'');u.ga1="UA-1303489-2";u.setallowlinker=false;u.inpage_linkid=false;if(u.inpage_linkid){_gaq.push(['_require','inpage_linkid','//www.google-analytics.com/plugins/ga/inpage_linkid.js'])};_gaq.push([u.prefix+'_setAccount',u.ga1]);u.anonymizeIp="false";if(u.anonymizeIp==="true"){_gaq.push(['_gat._anonymizeIp'])};_gaq.push([u.prefix+'_setDomainName',u.domain]);if(u.setallowlinker||u.domain=='none'){_gaq.push([u.prefix+'_setAllowLinker',true])};u.map={"order_subtotal":"ga_totalOverride"};u.extend=[];u.send=function(a,b,c,d,e,f,g){if(u.ev[a]||typeof u.ev.all!="undefined"){b.ga_events=b.ga_events||[];u.addEvent=function(v){if(typeof v.eventCategory=="undefined"||typeof v.eventAction=="undefined"){utag.DB("GA event Category or Action is not set");return;}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('7','hott.torrid');}catch(e){}

...
(function( formvalidation, $, undefined ) {
        ...
        theForm.validVal({
            fields: {
                ...
                $(this).click(function() {
                    ...
                    if($(this).attr("name") === "recaptcha_response_field" && $(this).next().attr("style").indexOf("opacity: 0")){
                        $("input[name=recaptcha_response_field]").next().attr("style","opacity: 1");
                    }
                    });
                },
     ...
     * ex: {"excludeElementByIdOrSelector": ["#recaptcha_response_field","input[name=submit_contact_form]"]}
     * @param config
     */

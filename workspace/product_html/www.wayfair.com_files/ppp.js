...
wcsbLoadImage('https://www.dsply.com/index.php?pid=rv4a0pklnx&e=product-detail-page-view&site=wayfair&cpi='+escCpi+'&localtimestamp='+timestamp+'');
}
}
function wcsbGetCpiFromJsParameter()
{
if ((typeof(Webcollage.cpi) != typeof(undefined)) && (Webcollage.cpi != null))
return Webcollage.cpi;
return "";
}
function wcsbGetCpi ()
{
...
{
setTimeout(wcsbSa, 1);
wcsbLoadScript('http://content.webcollage.net/wayfair/smart-button?ird=true&channel-product-id=' + encodeURIComponent(wcsbGetCpi()), 'wcsb-auto');
}

/* Requested File List: vendor/foresee/foresee-surveydef.js */
/* jshint ignore:start */
FSR.surveydefs = [{
    name: 'browse',
    invite: {
...
FSR.properties = {
    ...
    invite: {
        ...
        dialogs: [{
            ...
            blurb: "Thank you for visiting Wayfair.com. You have been selected to participate in a brief customer satisfaction survey to let us know how we can improve your experience.",
         ...
         */
        exclude: {
            local: ['/added.php', '/public/basket.php', '/checkout/'],
            referrer: []
        },
        include: {
            local: ['.']
    ...
    cpps: {
        ID: { //this will be the name of the cpp
            source: 'parameter',
            name: 'Id' //the value sent will be the value of the parameter
        }
    },
...
/* jshint ignore:end */
/* CB:766b6ff3f5cc8b7970c RqV:766b6ff3f5cc8b7970c */
/* RtV:766b6ff3f5cc8b7970c */
/* Timer[finished]: 8.987904 ms */
/* lang: */

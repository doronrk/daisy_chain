//tealium universal tag - utag.12 ut4.0.201411142021, Copyright 2014 Tealium.com Inc. All Rights Reserved.
var _qevents=_qevents||[];try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1};u.qacct="p-dea6KN570hBJX";u.base_url=(document.location.protocol=="https:"?"https://secure":"http://edge")+".quantserve.com/quant.js";u.map={"page_name":"_fp.event","order_revenue":"revenue"};u.extend=[];u.send=function(a,b,c,d,e,f,g){if(u.ev[a]||typeof u.ev.all!="undefined"){c=[];for(d in utag.loader.GV(u.map)){if(typeof b[d]!="undefined"&&b[d]!=""){e=u.map[d].split(",");for(f=0;f<e.length;f++){if(typeof b[d]=="object"){for(g=0;g<b[d].length;g++){c.push(e[f]+"."+b[d][g]);}}else if(e[f]=="orderid"||e[f]=="revenue"){u[e[f]]=b[d];}else{c.push(e[f]+"."+b[d]);}}}}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('12','alphaindustries.main');}catch(e){}

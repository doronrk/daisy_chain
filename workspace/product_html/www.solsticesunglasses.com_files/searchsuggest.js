	...
	if (app) {
		...
		app.searchsuggest = {
			...
			init : function(formId, fieldId, fieldDefault, resultsId, url) {
				...
				jQuery("<div id=\"" + resultsId + "\"></div>").insertAfter('.sitesearch');
				...
				// on click
				app.searchsuggest.acSearchField.click(function(e) {
					if (app.searchsuggest.acSearchField.val() != '') {
			...
			repositionResultsDiv : function()
			{
				...
				app.searchsuggest.acResultsDiv.css("top", 8);
				app.searchsuggest.acResultsDiv.css("width", 205);
				app.searchsuggest.acResultsDiv.css("left", 720);
				app.searchsuggest.acResultsDiv.css("z-index", "200");
			},

...
BrowserHistory = (function() {
    ...
    if (useragent.indexOf("opera") != -1) {
        ...
        browser.chrome = true; // Add Support for Chrome Browsers. Hack by IC.
    ...
    function getPlayers() {
        ...
        if (players.length == 0 || players[0].browserURLChange == null) {
    ...
    var _initialize = function () {
        ...
        if (browser.firefox || browser.ie8 || browser.chrome)
        {

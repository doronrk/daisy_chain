	...
	function ($, jQuery, dmJQuery){
		...
		if (typeof(pluckAppProxy.pluck_reviews_list) === 'undefined') {
			pluckAppProxy.pluck_reviews_list = function (listId, params) {
				...
				var buildActivityObj = function(review_top) {
					...
					retval.reviewOnKey = list_top.data("params").plckReviewOnKey;
					retval.reviewOnKeyType = list_top.data("params").plckReviewOnKeyType;
					return retval;
				};
				...
				$("a.pluck-review-down-link, a.pluck-review-up-link", list).click(function() {
					...
					var parentKey = null;
					if (params.plckReviewOnKeyType == "article") parentKey = new PluckSDK.ExternalResourceKey({Key: params.plckReviewOnKey});
				...
				var actObj = { reviewOnKey: params.plckReviewOnKey, reviewOnKeyType: params.plckReviewOnKeyType,
		...
		if (typeof(pluckAppProxy.pluck_reviews_rollup) === 'undefined') {
			pluckAppProxy.pluck_reviews_rollup = function (topId, params) {
				...
				pluckAppProxy.executeActivityCallbacks("ReviewRollupRendered", { reviewOnKey: params.plckReviewOnKey, reviewOnKeyType: params.plckReviewOnKeyType });
			};
		...
		if (typeof(pluckAppProxy.pluck_reviews_mostHelpful) === 'undefined') {
			pluckAppProxy.pluck_reviews_mostHelpful = function (topId, params) {
				...
				pluckAppProxy.executeActivityCallbacks("ReviewMostHelpfulRendered", { reviewOnKey: params.plckReviewOnKey, reviewOnKeyType: params.plckReviewOnKeyType });
			};
		...
		if (typeof(pluckAppProxy.pluck_reviews_recent) === 'undefined') {
			pluckAppProxy.pluck_reviews_recent = function (topId, params) {
				...
				pluckAppProxy.executeActivityCallbacks("ReviewRecentRendered", { reviewOnKey: params.plckReviewOnKey, reviewOnKeyType: params.plckReviewOnKeyType, category: params.plckDiscoveryCategory });
			};
		}
		...
		if (typeof(pluckAppProxy.pluck_reviews_topRated) === 'undefined') {
			pluckAppProxy.pluck_reviews_topRated = function (topId, params) {
				...
				pluckAppProxy.executeActivityCallbacks("ReviewTopRatedRendered", { category: params.plckDiscoveryCategory });

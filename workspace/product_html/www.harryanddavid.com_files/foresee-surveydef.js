...
FSR.properties = {
	...
	*/
    ...
    invite : {
        ...
        exclude : {
            urls:['/w/orderitem', '/h/orderitem', '/store/BECCardsMessagingView', '/store/OrderDisplay', '/store/BECLogonForm', '/store/LogonForm', 'BECOrderItemDisplay', 'BECCheckoutDisplay'],
            referrers:[],
            userAgents:[],
            browsers:[],
            cookies:[],
    ...
    events : {
        ...
        custom: {
            purchase: {
                ...
                repeat: false,
                source: 'url',
                patterns: [/orderokview/i,/orderid/i]
            }
        }
    },

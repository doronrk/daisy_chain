...
s.linkInternalFilters="javascript:,shop.com"
...
s.prop5=document.location.href;


if(!s.eVar18) {
s.eVar18=s.getQueryParam('tkr')
}

if(!s.eVar19) {
s.eVar19=s.getQueryParam('sourceid')
}

if(!s.eVar20) {
s.eVar20=s.getQueryParam('omcmp')
}
...
s.visitorNamespace="marketamerica"
s.trackingServer="marketamerica.112.2o7.net"

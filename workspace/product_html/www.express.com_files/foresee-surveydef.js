(function(){
    ...
    platform: 'phone',
    brand: 'Foresee',
    section: 'Express-Foresee',
    invite: {
        when: 'onentry',
        //corpLogo: 'fsrlogo.gif',
        corpLogo: 'https://survey.foreseeresults.com/images/logos/Express-Foresee.gif',
        corpAltText: 'Foresee',
        dialogs: [[{
    ...
    platform: 'phone',
    brand: 'Answers',
    section: 'Express-Answers',
    invite: {
        when: 'onentry',
        //corpLogo: 'answerslogo.gif',
        corpLogo: 'https://survey.foreseeresults.com/images/logos/Express-Answers.gif',
        corpAltText: 'Answers',
        dialogs: [[{
            reverseButtons: false,
            headline: "We'd welcome your feedback!",
    ...
    section: 'Express-ForeseeByAnswers',
    invite: {
        when: 'onentry',
        //corpLogo: 'fbyalogo.gif',
        corpLogo: 'https://survey.foreseeresults.com/images/logos/Express-ForeseeByAnswers.gif',
    ...
    links: {
        pop: [{
            tag: 'input',
            attribute: 'id',
            patterns: ['PayPal-Checkout', 'Paypal', 'BML'],
            pu: true
        }]
    },
    include: {
...
FSR.properties = {
    ...
    invite: {
        ...
        exclude: {
            urls: ['https', '/checkout/', '/check-out/', '/user/', '/loyalty/', '/login'],
            referrers: [],
            userAgents: [],
            browsers: [],
            cookies: [],

	...
	*/
    ...
    invite : {
        ...
        dialogs : [[{
            reverseButtons: false,
            headline: "We'd welcome your feedback!",
            blurb: "Thank you for visiting VeraBradley.com. You have been selected to participate in a brief customer satisfaction survey to let us know how we can improve your experience.",
    ...
    cpps: {
        isAuthenticated: { //this will be the name of the cpp
            source: 'cookie',
            init: 'N',
            name: 'isAuth', //the value sent will be the value of the cookie
            value: 'Y' //this value will be sent if the cookie is present. Can be used with "init" to set a "Y" or "N" value checking for the presence of a cookie
        }
    },

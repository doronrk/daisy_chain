...
N.nps='2';else
N.nps='3';}
N.analyticsCall=function(a,v,e){var type='';if(a==='qc'){type='qualified chat';}else{N.PageUpdate('A',"&call="+a+"&error=3");return;}
try{if(type!=''){var elem=document.createElement("img");elem.setAttribute('src','http://755-img.c3tag.com/v.gif?cid=755&c3ch=CHAT&c3nid=livechat');elem.setAttribute('alt','na');elem.setAttribute('height','1');elem.setAttribute('width','1');elem.setAttribute('border','0');elem.setAttribute('style','display: none');document.body.appendChild(elem);}}catch(err){N.PageUpdate('A',"&call="+a+'&error=4');}}

...
var QAS_Variables = {
    ...
    PROXY_PATH:     "../js/qas/qas_proxy.jsp",    //Standard Pro Web proxy file
    ADD_PROXY_PATH: "../js/qas/add_proxy.jsp",    //Additional Countries proxy file
    TD_PROXY_PATH:  "../js/qas/td_proxy.jsp",     //Email and Phone validation proxy file

    QAS_LAYOUT:     "Fry",   //the proweb configuration to use
 ...
 //   ],
    ...
    ADDRESS_FIELD_IDS: [
                        ["address1", "address2", "apartment", "city", "state", "zipCode"]
                       ],
  ...
  /*  PHONE_VALIDATE_COUNTRY: ["AIA",  //Anguilla
   ...
   // PHONE_VALIDATE_COUNTRY: ["ALL"], //ALL
    ...
    TIMEOUT:                 5000,  //ajax timeout for address validation
...
function Address() {
    ...
    var getAddresses = function () {
        ...
        for (i = 0; i < ids.length; i++) {
			...
			// var fieldValue =  document.getElementById(ids[i][j]).value;
...
function Clean(searchString, country_3, ajaxErr) {
    ...
    //var proxyToUse = QAS_Variables.PROXY_PATH;

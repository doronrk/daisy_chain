...
mybuys.initPage = function()
{
     ...
     {
			var testemail = Math.max(this.params['email'].toUpperCase().indexOf("TEST@EASTBAY.COM"),this.params['email'].toUpperCase().indexOf("ATADOMTEST@EASTBAY.COM"),this.params['email'].toUpperCase().indexOf("VBRIESE@EASTBAY.COM"));
          if(testemail<0)
          {
               this.base_initPage();
          }

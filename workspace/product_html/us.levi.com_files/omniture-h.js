...
s.trackingServer='metrics.us.levi.com';		//FPC URL (comment out if not using)
s.trackingServerSecure='smetrics.us.levi.com';	//FPC SSL URL (comment out if not using)
/* End Partner Config Section */
s.campaignID='pid,camp,fb_ref';			//campaign variable NOTE: follow Genesis integration
s.internalCID='ab';			//internal campaign id
s.internalclickid='clickid';		//The click ID from the URL parameter.  
s.visitorNamespace='levi';	//visitor namespace for cookie migration and for 3rd party cookies
...
function emailSignupCustomLinkTrack(obj, pageSlot) {
    if (esclt.events) {
		var newsLetter = 'Newsletter Signup';
		s.linkTrackVars='events,channel,prop1,prop2,prop18';
		s.linkTrackEvents=esclt.events;
		s.events=esclt.events;
		s.pageName=newsLetter;
		s.channel=newsLetter;
		s.prop1=newsLetter;
		s.prop2=newsLetter;
		s.prop18=newsLetter + ": " + pageSlot;
...
function facebookCustomLinkTrack(obj, styleCode, longTitle) {
	if (esclt.events) {
		s.linkTrackVars='events,eVar44,products';
		s.linkTrackEvents='event22';
		s.events='event22';
		s.products=";"+styleCode + ": " + longTitle+";;;;";
		s.eVar44=s.pageName
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function facebookshareCustomLinkTrack(obj, styleCode, longTitle) {
	if (esclt.events) {
		s.linkTrackVars='events,products';
...
function productCustomLinkTrack(obj, pageName, styleCode, longTitle) {
	if (esclt.events) {
		s.linkTrackVars='prop17,eVar35,products,events';
		s.linkTrackEvents='event23';
		s.prop17=pageName;
		s.eVar35=styleCode + ": " + longTitle + ": " + pageName;
		s.products=";"+styleCode + ": " + longTitle+";;;;";
		s.events='event23';
		s.tl(obj, 'o', esclt.friendlyName);
    }
...
function lookbookflyoutCustomLinkTrack(obj) {
	if (esclt.events) {
...
function findyourcurveCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='events';
...
function offsiteclickCustomLinkTrack(obj, linkname) {
	if (esclt.events) {
...
function cmsspotexpandCustomLinkTrack(obj, categoryid, slotnumber) {
	if (esclt.events) {
		s.linkTrackVars='prop17,eVar35,events';
		s.linkTrackEvents='event23';
		s.events='event23';
		s.prop17='CMS Spot Expand';
		s.eVar35=categoryid + ": CMS Spot Expand: " + slotnumber;
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function cmsspotcollapseCustomLinkTrack(obj, categoryid, slotnumber) {
	if (esclt.events) {
		s.linkTrackVars='prop17,eVar35,events';
		s.linkTrackEvents='event23';
		s.events='event23';
		s.prop17='CMS Spot Collapse';
		s.eVar35=categoryid + ": CMS Spot Collapse: " + slotnumber;
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function cmsspotshopnowCustomLinkTrack(obj, categoryid, slotnumber) {
	if (esclt.events) {
		s.linkTrackVars='prop17,eVar35,events';
		s.linkTrackEvents='event23';
		s.events='event23';
		s.prop17='CMS Spot Shop Now';
		s.eVar35=categoryid + ": CMS Spot Shop Now: " + slotnumber;
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function internalcampaignCustomLinkTrack(obj, abparamvalue) {
		s.linkTrackVars='eVar1';
		s.eVar1=abparamvalue;
		s.tl(obj, 'o', 'Internal Campaign');
    
}



/*  Start DFR HTML5 Tracking */

function findyourcurveCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='pageName,channel,prop1,prop2,prop21,prop22,eVar38,events';
		s.linkTrackEvents='event24,event25,event36,event9,event10';
		s.events='event24,event25,event36,event9,event10';
		s.pageName='Curve ID Quiz: Step 1: Waist';
		s.channel='Interactive: Curve ID Quiz';
		s.prop1='Interactive: Curve ID Quiz';
		s.prop2='Interactive: Curve ID Quiz';
		s.prop21='Curve ID Quiz: Step 1: Waist';
		s.prop22='Webstore';
		s.eVar38='Curve ID Quiz: Interactive: Find Your Curve';
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function revisitsteponeCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='pageName,channel,prop1,prop2,prop21,prop22,events';
...
function completesteponeCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='pageName,channel,prop1,prop2,prop21,prop22,events';
		s.linkTrackEvents='event11,event12';
		s.events='event11,event12';
		s.pageName='Curve ID Quiz: Step 2: Seat';
		s.channel='Interactive: Curve ID Quiz';
		s.prop1='Interactive: Curve ID Quiz';
		s.prop2='Interactive: Curve ID Quiz';
		s.prop21='Curve ID Quiz: Step 2: Seat';
		s.prop22='Webstore';
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function completesteptwoCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='pageName,channel,prop1,prop2,prop21,prop22,events';
		s.linkTrackEvents='event13,event14';
		s.events='event13,event14';
		s.pageName='Curve ID Quiz: Step 3: Issue';
		s.channel='Interactive: Curve ID Quiz';
		s.prop1='Interactive: Curve ID Quiz';
		s.prop2='Interactive: Curve ID Quiz';
		s.prop21='Curve ID Quiz: Step 3: Issue';
		s.prop22='Webstore';
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function answerstepthreeCustomLinkTrack(obj, stepthreeissue, stepthreeselection) {
	if (esclt.events) {
		s.linkTrackVars='prop19,prop22';
		s.prop19=stepthreeissue + ": " + stepthreeselection;
		s.prop22='Webstore';
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function completestepthreeCustomLinkTrack(obj, quizresult, s3issue1selection, s3issue2selection, s3issue3selection) {
	if (esclt.events) {
		s.linkTrackVars='pageName,channel,prop1,prop2,prop20,prop21,prop22,eVar36,eVar37,events';
		s.linkTrackEvents='event26,event27';
		s.events='event26,event27';
		s.pageName="Curve ID Quiz: Results: " + quizresult;
		s.channel='Interactive: Curve ID Quiz';
		s.prop1='Interactive: Curve ID Quiz';
		s.prop2='Interactive: Curve ID Quiz';
		s.prop20=s3issue1selection + ": " + s3issue2selection + ": " + s3issue3selection;
		s.prop21='Curve ID Quiz: Step 3: Issue';
		s.prop22='Webstore';
		s.eVar36="Curve ID Quiz: " + quizresult;
		s.eVar37='Curve ID Quiz';
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function dfrstartoverCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='pageName,channel,prop1,prop2,prop21,prop22,events';
		s.linkTrackEvents='event9,event10,event32,event33';
		s.events='event9,event10,event32,event33';
		s.pageName='Curve ID Quiz: Step 1: Waist';
		s.channel='Interactive: Curve ID Quiz';
		s.prop1='Interactive: Curve ID Quiz';
		s.prop2='Interactive: Curve ID Quiz';
...
function dfrshopnowCustomLinkTrack(obj, shopnowlegopening, shopnowrise) {
	if (esclt.events) {
		s.linkTrackVars='prop22,eVar41,events';
		s.linkTrackEvents='event43,event44,event26,event27';
		s.events='event43,event44,event26,event27';
		s.prop22='Webstore';
		s.eVar41=shopnowlegopening + ": " + shopnowrise;
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function getstartedmeasureyourselfCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='prop22,eVar38,events';
		s.linkTrackEvents='event36';
		s.events='event36';
		s.prop22='Webstore';
		s.eVar38='Curve ID Quiz: Interactive: Measure Yourself at Home';
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function booknowfittingCustomLinkTrack(obj) {
	if (esclt.events) {
		s.linkTrackVars='prop22,eVar38,events';
		s.linkTrackEvents='event36';
		s.events='event36';
		s.prop22='Webstore';
		s.eVar38='Curve ID Quiz: Interactive: Get a Custom Fitting';
		s.tl(obj, 'o', esclt.friendlyName);
    }
}

function playvideoCustomLinkTrack(obj, videoname) {
	if (esclt.events) {
		s.linkTrackVars='prop22,eVar42,events';
...
function playcompletesCustomLinkTrack(obj) {
	if (esclt.events) {
...
/*New vs. repeat allocation 90 Dat expiration visit*/
/*****************************************************/
	s.eVar21=s.prop23=s.getNewRepeat90();	
...
/*Capture the Current Pagename Value and assign to a custom Traffic Variable*/
/**********************************************************************/

	s.prop14="D=pageName";

/*Capture the Current Pagename Value and assign to a custom Traffic Variable - DFR*/
/**********************************************************************/

	s.prop21="D="+s.pageName;

/*Capture the Previous Pagename value and assign to a custom Traffic Variable*/
/**********************************************************************/
...
/*Capture the Application (Webstore, Facebook, etc) and assign to a custom Traffic Variable*/
/**********************************************************************/
	s.prop22="Webstore";

/*Fire Custom Page View Event on every page*/
/**********************************************************************/
	/*s.events='event49'; Removed - JD 09-30-2011**/

/*socialPlatforms v1.0 - used for SocialAnalytics*/
/**********************************************************************/
	s.socialPlatforms('eVar47');

/*eDialog Message ID*/
		 s.eVar70 = s.getQueryParam('ED_MID');
		 s.eVar70 = s.getValOnce(s.eVar70,'s_var_70',0);


/* eDialog Recipient ID */
		 s.eVar71 = s.getQueryParam('ED_RID');
         s.eVar71 = s.getValOnce(s.eVar71,'s_var_71',0);
...
/* new vs repeat 90 Days */
s.getNewRepeat90=new Function(""
+"var s=this,e=new Date(),cval,ct=e.getTime(),y=e.getYear();e.setTime"
+"(ct+90*24*60*60*1000);cval=s.c_r('s_nr');if(cval.length==0){s.c_w("
+"'s_nr',ct,e);return 'New';}if(cval.length!=0&&ct-cval<90*60*1000){s"
+".c_w('s_nr',ct,e);return 'New';}if(cval<1123916400001){e.setTime(cv"

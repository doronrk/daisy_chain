...
}};truste.ca.tmNotFound=null;truste.ca.stopNotFoundTm=function(){if(truste.ca.tmNotFound){clearTimeout(truste.ca.tmNotFound);
truste.ca.tmNotFound=null}};truste.ca.addClearAdIcon=function(I){truste.ca.adTypeMap[I.baseName]=1;var d=truste.ca.findCreative(I);
...
}I.docRef=top.document}catch(C){window.console&&console.log&&console.log(C.message)}}if(!d){if(!truste.ca.tmNotFound){truste.ca.tmNotFound=setInterval(function(){for(var a in truste.ca.bindMap){var b=truste.ca.bindMap[a];
truste.ca.resetLocations(b)}},750);setTimeout(function(){truste.ca.stopNotFoundTm()},5000)}return}truste.ca.stopNotFoundTm();
truste.ca.contMap[I.baseName]=d;var B=truste.ca.getIconOverlayElement(I);B.style.cursor="pointer";var M=truste.ca.adTypeMap[I.baseName];
if(M&&M!==2){B.onclick=function(){truste.ca.iconClickHandler(this)}}if(I.cam=="1"){var G=truste.ca.flattenNode(B);
for(var w=0;w<G.length;w++){var r=G[w];if(r&&r.nodeType==3){if(r.length>10){B.style.width="120px"}}}}var l=d;
if(d.parentNode.nodeName.equalsIgnoreCase("a")){l=d.parentNode}l.parentNode.insertBefore(B,l);var D=truste.ca.isInsidePositionedParent(d);
if(D){I.positionedParent=D}I.htmlMarginOffset={htmlTop:0,htmlLeft:0};var g=truste.ca.IEVersion();if(g&&g<9&&truste.ca.isQuirksMode()){var f=d.parentNode;
if(f){var E=truste.ca.getAncestors(f);if(E.length>0){var F=E.pop();do{var c=F.nodeName.toLowerCase();
if(c=="table"||c=="center"){I.lastAncestor=null;break}else{if(F.offsetLeft){I.lastAncestor=F;break}}}while(F=E.pop())
}}}else{if(!g&&!I.positionedParent){var h=truste.ca.calcPageMargin(d);I.htmlMarginOffset.htmlLeft=h[0];
I.htmlMarginOffset.htmlTop=h[1]}}B.style.left=truste.ca.getIconLeftPosition(d,B,I)+"px";B.style.top=truste.ca.getIconTopPosition(d,B,I)+"px";
var p=truste.ca.getNodePath(truste.ca.contMap[I.baseName]);var L=[];for(var k=0;k<p.length;k++){var A=p[k];
L.push([A.offsetLeft,A.offsetTop])}truste.ca.osMap[I.baseName]=L;truste.ca.bindEvent(d,"DOMNodeInserted",function(){truste.ca.resetIcon(I)
},false);var N=setInterval(function(){truste.ca.compareOffsets()},24);truste.ca.intervalStack.push(N);
var v=d.style.overflow!="hidden"?truste.ca.flattenNode(d):[];truste.ca.clipValues={};var H=false;for(var K=0;
K<v.length;K++){var u=v[K];if(u.nodeType===1&&u.nodeName.toLowerCase()==="div"&&!I.celtra){if(u.offsetWidth>(I.width+7)||u.offsetHeight>(I.height+7)){var s=truste.ca.getClipStyle(u,I.docRef);
...
return false};truste.ca.getAdmarkerIcon=function(i){var e="77px";var j="15px";var k;var l="0";if(i.cam=="0"){k=i.icon_cam
...
}else{if(i.cam=="10"){e="30px";j="30px";k=i.icon_cam_daa}else{e="12px";j="12px";k=i.icon;l="2px"}}}}}var g=truste.ca.findSwf(truste.ca.contMap[i.baseName]);
...
i.hideLink="javascript:self.close()";truste.ca.adTypeMap[i.baseName]=2}var m="background: transparent !important; display: inline !important; position: static !important; transform: none !important; -webkit-transform: none !important; -ms-transform: none !important";
var d='<span style="line-height:15px;vertical-align:top;'+m+'">';if(i.cam!="3"&&i.cam!="4"&&i.cam!="6"&&i.cam!="9"&&i.cam!="10"){d+='<span style="font-size:8pt;font-weight:normal;text-transform:none;color:#000;margin: 0 13px 0 0;'+m+'">'+i.iconText+"</span>"
}d+='<img width="'+e+'" height="'+j+'" style="background:transparent !important;margin:0;padding:0;border:none;position:absolute;right:0px;top:'+l+';" src="'+k+'"/></span></a></span>';
...
}var c=g?f:d;return{icon:c,isSwfIcon:g}};truste.ca.getIconOverlayElement=function(u){var s=truste.ca.getAdmarkerIcon(u);
...
}else{if(u.cam=="5"){n.width="77px";n.height="15px";n.top="0";n.right="0"}else{if(u.cam=="6"){n.width="40px";
...
if(o){g='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" id="tecafi" width="58" height="16" style="position: relative"><param name="flashVars" value="bindingId='+u.baseName+'"/><param name="allowScriptAccess" value="always"/><param name="movie" value="'+window.location.protocol+'//choices.truste.com/get?name=wmodeIcon.swf"><param name="quality" value="high"><embed name="banner" allowScriptAccess="always" flashVars="bindingId='+u.baseName+'" src="'+window.location.protocol+'//choices.truste.com/get?name=wmodeIcon.swf" quality="high" width="58" height="16" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"></embed></object></span>'
...
truste.ts=new Date();truste.seq="0"};truste.ca.getIconLeftPosition=function(g,c,q){var a=truste.ca.calcOffset(g,"offsetLeft",q);
...
var d=document.getElementById(a.iconSpanId);d.parentNode.removeChild(d);var e=(window.location.protocol=="http:")?"http://choices.truste.com/get?name=":"https://choices.truste.com/get?name=";

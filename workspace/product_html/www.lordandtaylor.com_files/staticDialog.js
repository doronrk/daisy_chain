...
if(!dojo._hasResource["dijit.staticDialog"]){
dojo._hasResource["dijit.staticDialog"]=true;
dojo.provide("dijit.staticDialog");
...
var ds=dijit._staticDialogStack,_4=948+ds.length*2;
if(ds.length==1){
_3.show();
var _is=dijit._underlay.node.style,_os=dijit._underlay.domNode.style;
var _2=dojo.coords(dojo.body());
_os.top=_2.t+"px";
_os.left=_2.l+"px";
_is.width=_2.w+"px";
_is.height=_2.h+"px";
...
var ds=dijit._staticDialogStack;
if(ds.length==0){
...
if(_a.charOrCode!==dk.TAB){
//Do not stop event if jQuery dialog displayed.
var jqDDisp = false;
var jqD = dojo.query(".ui-dialog").style("display");
for (var i in jqD) { 
	if (jqD[i] === "block") jqDDisp = true; 
}
if (!jqDDisp) dojo.stopEvent(_a);
}else{
if(!dojo.isOpera){
try{
...
this._size();
this._position();
dijit._staticDialogStack.push(this);
this._fadeIn.play();
...
dojo.declare("dijit.staticDialog",[dijit.layout.ContentPane,dijit._DialogBase],{});
dijit._staticDialogStack=[];

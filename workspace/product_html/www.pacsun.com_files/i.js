...
bouncex.website = {"cae":false,"ei":0,"cookie_name":"bounceClientVisit575","base_host":"bounceexchange.com","vars":{"cart_quantity":{"polling":"all","persist":"no","val":"parseInt(jQuery('.linkminicart').text())","default":""},"cart_total":{"polling":"all","persist":"no","val":"parseFloat(jQuery('#minicart .ordersubtotal').text().match(\/\\d+\\.\\d+\/))","default":""},"is_logged_in":{"polling":"none","val":"$('.loggedIn').text().indexOf('Sign Out')>0","default":""},"is_opted_in":{"polling":"none","persist":"no","val":"document.cookie.indexOf('optInEmail')!==-1","default":"false"},"is_homepage":{"polling":"none","persist":"no","val":"jQuery('body.homepage-section').length>0","default":"false"},"gender_of_user":{"polling":"none","persist":"no","val":"(function(){var arr = decodeURIComponent(getBounceCookie('PS')).split(';'),el,g = false;for(var i=0;i<arr.length;i++){el=arr[i].split('=');if(el[0]=='g') g = el[1];} return g;})();","default":""},"is_shipping_to_us":{"polling":"none","persist":"no","val":"jQuery('#header').find('a.ship-to-us').length==0","default":"true"},"bigdoor":{"polling":"none","persist":"no","val":"jQuery('.bd-gambit-container').length>0?true:false","default":"false"},"ibx_cponcode":{"polling":"none","persist":"visit","val":"bouncex.vars.ibx_cponcode.length?bouncex.vars.ibx_cponcode:(location.href.match(\/bxcpncodez\/)?location.href.match(\/bxcpncodez=([a-z0-9\\-\\_]+)\/i)[1]:'')\n\n","default":""},"checkout":{"polling":"none","persist":"no","val":"utag_data.page_type == \"checkout\" && !utag_data.order_grandTotal","default":"false"},"login_lightbox":{"polling":"all","persist":"no","val":"!!jQuery('.gigya-screen-dialog').length","default":"false"},"promo_not_applied":{"polling":"none","persist":"no","val":"!!(jQuery('.productcolumn .name .uppercase:contains(Promo Code:)').length && jQuery('.itemtotalcolumn:contains(Not Applied)').length);","default":""},"pants_page":{"polling":"none","persist":"no","val":"bouncex.ibx._getparam('cgid').indexOf('pants') > -1 || bouncex.ibx._getparam('cgid').indexOf('jeans') > -1","default":"false"}},"acts":[],"pi":1000,"ct":"bind_to_domain","tcjs":"","cjs":"(function(){\n    setTimeout(function(){\n        var campaignsArr  = [65281, 62488, 62489], \/\/ <--- include campaign_id separated by comma here.\n            bigDoorElment = document.getElementsByClassName('bd-gambit-container');\n\n        for(var i = 0; i < campaignsArr.length; i++) {\n            if( bouncex.campaigns[ campaignsArr[i] ] && bigDoorElment.length ) {\n                bouncex.other_report(35829, 'pops');\n            } else if ( bouncex.campaigns[ campaignsArr[i] ] && !bigDoorElment.length ) {\n                bouncex.show_ad( campaignsArr[i] );\n            }\n        }\n    }, 1000);\n})();\n\nbouncex.other_report = function(ca_id, eventname){\n    if (!bouncex.campaigns[ca_id]) {\n        bouncex.campaigns[ca_id]={};\n     }\n     if (!bouncex.cookie.campaigns[ca_id]){\n         bouncex.cookie.campaigns[ca_id]={\n         lavid: bouncex.cookie.vid,\n         la: getTime2(),\n         cv_id: 0\n         };\n     }\n     bouncex.report(ca_id,eventname);\n     setBounceCookie();\n}","PMI":500,"PDI":1000,"PMR":30,"force_https":false,"waypoints":false,"gai":"","ots":0,"sd":0,"aco":{"first_party_limit":"3500"},"id":575,"campaign_id":0,"tpc":0,"uwc":1,"domain":"pacsun.com","bau":"api.bounceexchange.com","is_preview":false,"mas":2,"map":1,"burls":[],"ibx":{"cjs":"bouncex.ibx.track('event','bouncex conversion');","miw":"0","mibcx":1,"te":1,"tjs":"\/\/mobile product page\nbouncex.ibx.cvar.iz_mobile_product = window.location.href.indexOf('mProduct') > -1;\n\n\/\/Page Type\nif(typeof(utag_data) != 'undefined'){\n  bouncex.ibx.cvar.page_type = utag_data.page_type;\n}\n\/\/Quickview Tracking\nbouncex.ibx.monitor_quickview_item = function (event_name) {\n    clearInterval(window.bouncex.ibx.cvar.closeInt);\n    window.bouncex.ibx.cvar.intCheck = setInterval(function(){\n\n        if (!jQuery('.ui-widget-overlay').is(':visible')) return;\n        window.bouncex.ibx.cvar.segment = jQuery('h1.productname').text();\n        var quickview_data = {\n            creative: jQuery('#iz img').attr('src'),\n            copy: jQuery('h1.productname').text(),\n            subcopy: jQuery('h2.productname').text(),\n            sku: jQuery('.productid').text().replace(\/[^0-9\\\/]\/g,'')\n        };\n        window.bouncex.ibx.track('item', quickview_data.sku, quickview_data);\n        window.bouncex.ibx.track('event', event_name);\n        window.bouncex.ibx.track('event','viewed item');\n        window.bouncex.ibx.monitor_quickview_item_clear();\n    }, 500);\n}\nif(typeof(utag_data)=='undefined'){\n  utag_data = {};\n}\n$( document ).ajaxComplete(function(data, xhr, settings){\n\n    if(settings.url.indexOf('MiniAddProduct')>0){\n      var cookie = getBounceCookie('_ibx_ci')||'';\/\/cart cookie\n      if(cookie.length<200){\/\/care about cookie size\n          cookie += cookie?'|':'';\n         cookie += settings.data;\n          bouncex.ibx._cookies.create('_ibx_ci',cookie,1);\n          bouncex.ibx.track('cart','all',{value:cookie});\n      }\n    }\n});\n\nbouncex.ibx.monitor_quickview_item_clear = function () {\n    clearInterval(window.bouncex.ibx.cvar.intCheck);\n    window.bouncex.ibx._log('monitor quickview cleared');\n    window.bouncex.ibx.cvar.closeInt = setInterval(function(){\n        if (jQuery('.ui-widget-overlay').is(':visible')) return;\n        window.bouncex.ibx.monitor_quickview_item('viewed quickview ' + window.bouncex.ibx.cvar.page_type);\n    }, 500);\n}\nif(bouncex.ibx.cvar.page_type == 'category' || bouncex.ibx.cvar.page_type == 'sub-category'){\n  bouncex.ibx.monitor_quickview_item('viewed quickview ' + bouncex.ibx.cvar.page_type);\n}\n\n\/* set custom variables *\/\n\/\/bouncex.ibx.cvar.product_page = utag_data.page_type=='product';\nbouncex.ibx.cvar.product_page = jQuery('meta[property=og:type]').attr('content') == 'product';\nbouncex.ibx.cvar.items_in_cart = parseInt(jQuery('.minicarttotal .linkminicart').text() || jQuery('.minicarttotal .emptycart').text());\n\n\n\/* track item *\/\nif(bouncex.ibx.cvar.product_page || bouncex.ibx.cvar.iz_mobile_product){\n    var brandName = jQuery('h1.productname').text().trim();\n    var productName = jQuery('h2.productname').text().trim();\n    var productId = jQuery('.productid').text().replace(\/[^0-9\\\/]\/g,'');\n    var ogImgUrl = jQuery('#izView img').attr('src');\n    var imgUrl = ogImgUrl.substring(0, ogImgUrl.lastIndexOf(\"?\"));\n    bouncex.ibx.cvar.segment = brandName;\n    var data = { \n        creative: imgUrl\n        ,copy: brandName\n        ,subcopy: productName\n        ,sku: productId\n        ,creativeAlt: productName\n        ,product_id: productId\n        ,__width: jQuery('img[src^='+imgUrl+']').width()\n        ,__height: jQuery('img[src^='+imgUrl+']').height()\t\t\n    };\n    if(data.copy != 'null'){\n    \tbouncex.ibx.track('item',data.sku,data,bouncex.ibx.cvar.segment);\n    \t\/* trigger *\/\n    \tbouncex.ibx.track('event','viewed item');\n    }\n}\n\n\n\/* monitor user sources *\/\nvar ibx_usr_src = {\n    url_cyEmail: bouncex.ibx._getparam('cyEmail')\n    ,url_email: bouncex.ibx._getparam('email')\n    ,url_eemail: bouncex.ibx._getparam('eemail')\n    ,cookie_optInEmail: decodeURIComponent(bouncex.ibx._cookies.read('optInEmail'))\n};\nfor(var key in ibx_usr_src) {\n    if(ibx_usr_src.hasOwnProperty(key)\n        && ibx_usr_src[key]!=''\n        && bouncex.ibx.uid==0) {\n        bouncex.ibx.user(ibx_usr_src[key],{__src:key})\n    }\n}\n\n\/* track events *\/\nibx_iic_poll = setInterval(function(){\n    var item_count = parseInt(jQuery('.minicarttotal .linkminicart').text() || jQuery('.minicarttotal .emptycart').text())\n        ,track_event = false;\n    if(isNaN(item_count) || isNaN(bouncex.ibx.cvar.items_in_cart)) {\n        return;\n    }\n    else if(bouncex.ibx.cvar.items_in_cart>0 && item_count==0) {\n        track_event = 'cart emptied';\n    }\n    else if(item_count < bouncex.ibx.cvar.items_in_cart) {\n        track_event = 'removed from cart';\n    }\n    else if(item_count > bouncex.ibx.cvar.items_in_cart) {\n        track_event = 'added to cart';\n    }\n    if(track_event) {\n        bouncex.ibx.track('event',track_event,{\n            old_count:bouncex.ibx.cvar.items_in_cart\n            ,new_count:item_count\n        });\n        bouncex.ibx.cvar.items_in_cart = item_count;\n    }\n},1000);","cart_rep":{"get":"","set":"(function(){if(jQuery('#minicart .emptycart').length > 0){var e=decodeURIComponent(decodeURIComponent(bouncex.ibx._getparam(\"ibx_cart\")));if(e){var t=e.split(\"|\");var n=0;jQuery(t).each(function(e,r){var i=new Date;jQuery.ajax({url:\"\/on\/demandware.store\/Sites-pacsun-Site\/default\/Cart-MiniAddProduct\",type:\"POST\",cache:false,data:r,complete:function(){n++;if(n==t.length){window.location.reload()}}})})}}})()"}}};

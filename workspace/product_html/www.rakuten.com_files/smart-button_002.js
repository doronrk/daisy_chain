...
wcsbLoadImage('https://www.dsply.com/index.php?pid=rv4a0pklnx&e=product-detail-page-view&site=buycom&cpi='+escCpi+'&localtimestamp='+timestamp+'');
}
}
...
{ return wcCpi; }
else if ((typeof(vsr_sku) != typeof(undefined)) && (vsr_sku != null))
{ return vsr_sku; }
else
{ return ""; }
}
...
{
setTimeout(wcsbSa, 1);
wcsbLoadScript('http://content.webcollage.net/buycom/smart-button?ird=true&channel-product-id=' + encodeURIComponent(wcsbGetCpi()), 'wcsb-auto');
}

...
/* Generated: Apr 28, 2010 10:42:13 AM */
...
if(D.flopac<0){D.flopac=0;}if(D.flopac>100){D.flopac=100;}}}function ii_getDomain(){var B=document.domain;return(B);}function ii_callServer(F,E){var D=(ii_callServer.arguments.length==3)?ii_callServer.arguments[2]:window;var C=D.document.getElementsByTagName("head").item(0);
...
this.version=14;this.accountid=7566;this.ishosted=true;this.domain="";this.rsvr="rs.instantservice.com";this.gsvr="gs.instantservice.com";
this.vtscrname="";this.vtscrloc="";this.GSV_COOKIE="IS3_GSV";this.HIST_COOKIE="IS3_History";this.HIST_COOKIE_EXP=null;if(this.HIST_COOKIE_EXP!=null){this.HIST_COOKIE_EXP.setTime(this.HIST_COOKIE_EXP.getTime()+(0*60*1000));
...
if(window.isChatTestServer === true){window.ii_deployment = 1;}if(ii_Var.IE||ii_Var.MZ){ii_start();}
...
$(document).ready(function(){
	$('.dealTile-content').each(function(index){
		$('.linkText', this).click(function(){
			var linkText = $(this).text();
			var s = s_gi(s_account);
			s.eVar38 = 'cm_re-_-pagecontent-_-deal' + (index/2+1) + '-_-'+linkText;
			s.eVar39 = 'outlet:promotion_days of deals';

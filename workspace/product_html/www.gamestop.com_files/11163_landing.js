...
var ci_vid= 11163;
var ci_cookieDomain=".gamestop.com";
var ci_refDomain=".gamestop.com";
var ci_imgs=[];
...
try {
	...
	//TRG
	if(document.location.href=='http://www.gamestop.com/'){
		ci_FP('bs.serving-sys.com/BurstingPipe/ActivityServer.bs?cn=as&amp;ActivityID=277410&amp;ns=1');
	}
